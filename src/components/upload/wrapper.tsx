...
export const UploadWrapper: React.FC<{
...
}> = ({ uploadFile, createFile, children }) => {
  ...
  return (
    <div className="w-full h-full relative" ref={drop}>
      {uploadFutures.length > 0 && (
        <div className="w-full h-full bg-black cursor-pointer rounded text-white hover:shadow-lg flex items-center bg-opacity-50">

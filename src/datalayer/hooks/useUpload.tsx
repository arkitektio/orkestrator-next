import { CredentialsFragment, PresignedPostCredentialsFragment, RequestMediaUploadDocument, RequestMediaUploadMutation, RequestMediaUploadMutationVariables } from "@/mikro-next/api/graphql";
...
const uploadToStore = async (file: File, endpointUrl: string, z: PresignedPostCredentialsFragment, options?: UploadOptions) => {
    if (!z) {
  ...
  export const useUpload = () => {
    ...
    const upload = useCallback(async (file: File) => {
        ...
        let  data = await client.mutate<RequestMediaUploadMutation, RequestMediaUploadMutationVariables>({

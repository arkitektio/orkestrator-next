...
export type CudaSelector = Selector & {
  ...
  cudaCores: Scalars['Int']['output'];
  /** The minimum cuda version */
  cudaVersion: Scalars['String']['output'];
  kind: Scalars['String']['output'];
  required: Scalars['Boolean']['output'];
};
...
export type CudaSelectorFragment = { __typename?: 'CudaSelector', cudaVersion: string, cudaCores: number };

export type RocmSelectorFragment = { __typename?: 'RocmSelector', apiVersion: string, apiThing: number };

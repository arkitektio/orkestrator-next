...
import { StagingMeasurementEdge, StagingRelationEdge, StagingStepEdge } from "../types";
...
export default ({
  ...
  return (
    <>
      <BaseEdge path={path} markerEnd={markerEnd} label={data?.template} />
      <EdgeLabelRenderer>
        <Card
          style={{
            position: "absolute",

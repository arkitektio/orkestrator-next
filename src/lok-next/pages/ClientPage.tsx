...
export default asDetailQueryRoute(withLokNext(useDetailClientQuery), ({data}) => {


  return (
    <PageLayout actions={<MikroDataset.Actions id={data?.client?.id} />} title={data?.client?.release.app.identifier}>

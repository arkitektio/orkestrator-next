...
export type PartialTransformationViewInput = {
  ...
  matrix: Scalars["FourByFourMatrix"]["input"];
...
export type TransformationView = View & {
  ...
  matrix: Scalars["FourByFourMatrix"]["output"];
...
export type ImageFragment = {
  ...
  views: Array<
    ...
    | {
        ...
        zMin?: number | null;
        zMax?: number | null;
        stage: { __typename?: "Stage"; id: string };
      }
  >;
  renders: Array<
    | {
...
type View_TransformationView_Fragment = {
  __typename?: "TransformationView";
  zMin?: number | null;
  zMax?: number | null;
};
...
export type ViewFragment =
  ...
  | View_TransformationView_Fragment;
...
export type TransformationViewFragment = {
  __typename?: "TransformationView";
  id: string;
  kind: TransformationKind;
  matrix: any;
...
export type From_Array_LikeMutationVariables = Exact<{
  ...
  transformationViews?: InputMaybe<
    Array<PartialTransformationViewInput> | PartialTransformationViewInput
  >;
...
export const From_Array_LikeDocument = gql`
  mutation from_array_like(
    ...
    $transformationViews: [PartialTransformationViewInput!]

...
export type GraphFragment = { __typename?: 'Graph', id: string, name: string };
...
export type GetGraphQuery = { __typename?: 'Query', graph: { __typename?: 'Graph', id: string, name: string } };

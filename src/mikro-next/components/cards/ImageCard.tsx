  ...
  return (
    <MikroImage.Smart
      ...
      dragClassName={({ isOver, canDrop, isSelected, isDragging }) =>
        `relative rounded group text-white bg-center bg-background shadow-lg h-60 rounded roounded-lg hover:bg-back-800 transition-all ease-in-out duration-200 group ${
    ...
    >
      ...
      <div
        className="px-2 py-2 h-full w-full absolute rounded-lg rounded  top-0 left-0 bg-opacity-20  hover:bg-opacity-10 transition-all ease-in-out duration-200 flex flex-row break-all"
        style={{

...
export const ROIContextMenu = forwardRef<HTMLDivElement, ROIContextMenuProps>(
  ({ open, onOpenChange, x, y }, ref) => {
    const {
      allowRoiDrawing,
      roiDrawMode,
      setShowRois,
...
ROIContextMenu.displayName = "ROIContextMenu";

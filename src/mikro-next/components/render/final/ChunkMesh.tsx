...
import { blueColormap, createColormapTexture, greenColormap, redColormap, viridisColormap } from "./colormaps";
...
const getColormapForView = (view: RgbViewFragment) => {
  ...
  export const ChunkBitmapTexture = ({
    ...
    const xPosition = box_position_3d[1] * box_shape[1] + box_shape[1] / 2 - imageWidth / 2;
    const yPosition = box_position_3d[0] * box_shape[0] + box_shape[0] / 2 - imageHeight / 2;

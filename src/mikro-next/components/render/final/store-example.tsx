...
async function demonstrateEnhancedStore() {
    ...
    console.log("Making 3 concurrent requests for the same item...");
    const promises = [
    ...
    console.log("All requests completed. Results are identical:",
    ...
    console.log("Is 'data/array.zarr' cached?", store.isCached("data/array.zarr"));

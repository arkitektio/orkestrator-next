    ...
    <div className="w-full p-2">
      <Tabs defaultValue={"metrics"} className="w-full">
        ...
        <TabsContent value={"measurements"}>
          <div className="text-md ml-3 my-3">Marked as Roi</div>
          ...
          <div className="text-md ml-3 my-3">Marked in Image</div>

          <div className="grid grid-cols-2 gap-2">
            {data?.entity?.specimenViews.map((view, i) => (
              <MikroSpecimenView.DetailLink
                object={view.id}
                className={"p-2 truncate w-[200px] h-[200px] border-0 "}
              >
                <ImageRGBD image={view.image} />
              </MikroSpecimenView.DetailLink>
            ))}
          </div>
        </TabsContent>

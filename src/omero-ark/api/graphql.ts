...
export function useEnsureOmeroUserMutation(
  ...
  return Apollo.useMutation<
    EnsureOmeroUserMutation,
    EnsureOmeroUserMutationVariables
  >(EnsureOmeroUserDocument, options);
}
export type EnsureOmeroUserMutationHookResult = ReturnType<
  typeof useEnsureOmeroUserMutation
>;
export type EnsureOmeroUserMutationResult =
  Apollo.MutationResult<EnsureOmeroUserMutation>;
...
export function useListDatasetsQuery(
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<ListDatasetsQuery, ListDatasetsQueryVariables>(
...
export function useListDatasetsLazyQuery(
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<ListDatasetsQuery, ListDatasetsQueryVariables>(
    ListDatasetsDocument,
    options,
  );
}
export type ListDatasetsQueryHookResult = ReturnType<
  typeof useListDatasetsQuery
>;
export type ListDatasetsLazyQueryHookResult = ReturnType<
  typeof useListDatasetsLazyQuery
>;
...
export function useListImagesQuery(
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<ListImagesQuery, ListImagesQueryVariables>(
    ListImagesDocument,
    options,
  );
}
export function useListImagesLazyQuery(
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<ListImagesQuery, ListImagesQueryVariables>(
    ListImagesDocument,
    options,
  );
}
export type ListImagesQueryHookResult = ReturnType<typeof useListImagesQuery>;
export type ListImagesLazyQueryHookResult = ReturnType<
  typeof useListImagesLazyQuery
>;
export type ListImagesQueryResult = Apollo.QueryResult<
  ListImagesQuery,
  ListImagesQueryVariables
>;

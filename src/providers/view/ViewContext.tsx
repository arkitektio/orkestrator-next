...
export const nullOrSmaller = (a: number | undefined | null, b: number | undefined | null) => {
...
export const nullOrBigger = (a: number | undefined | null, b: number | undefined | null) => {
    if (a == undefined || a == null) {
        return true;
    }
    if (b == undefined || b == null) {
...
export const viewIncludesView = (viewToCheck: ActiveView, activeView: ActiveView) => {

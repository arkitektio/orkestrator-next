...
export const AppLayout = ({ children, navigationBar }: AppLayoutProps) => {
  ...
  return (
    <div className="flex-grow flex flex-col md:flex-row bg-sidebar dark:text-white h-screen">
      ...
      <div className="flex-initial md:flex-colz-10 md:w-(--sidebar-width)  shadow shadow-xl bg-sidebar hidden md:block border-r">
        <NavigationMenu
      ...
      {/* Main content area */}
      <div className="flex-grow flex overflow-y-auto z-2 bg-sidebar shadow shadow-xs md:mr-1">
        {children}
      </div>

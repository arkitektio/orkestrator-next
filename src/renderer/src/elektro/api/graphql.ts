...
export type Distribution = {
  ...
  /** The value at the most distal segment (required for 'linear'). */
  distalValue?: Maybe<Scalars['Float']['output']>;
  ...
  /** The value at path distance 0 (required for 'linear'). */
  proximalValue?: Maybe<Scalars['Float']['output']>;
  /** The uniform value applied to every segment (required for 'uniform'). */
...
export type DistributionInput = {
  /** The value at the most distal segment (required for 'linear'). */
  distalValue?: InputMaybe<Scalars['Float']['input']>;
  /** An expression in `x` (normalized position) and `d` (path distance) (required for 'expression'). */
  expression?: InputMaybe<Scalars['String']['input']>;
  /** The kind of spatial distribution. */
  kind?: DistributionKind;
  /** The value at path distance 0 (required for 'linear'). */
  proximalValue?: InputMaybe<Scalars['Float']['input']>;
  /** The uniform value applied to every segment (required for 'uniform'). */

...
export type Task = {
  ...
  /** This assignation id. */
  assignationId: Scalars['String']['output'];
  ...
  /** The immediate parent assignation id, if any. */
  parentAssignationId?: Maybe<Scalars['String']['output']>;
  /** The root assignation id of the whole causal tree. */
  rootAssignationId: Scalars['String']['output'];

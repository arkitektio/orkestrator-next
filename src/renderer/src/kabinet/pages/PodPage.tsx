  ...
  return (
    <KabinetPod.ModelPage
      ...
      sidebars={
        <MultiSidebar
          map={{
    export default asDetailQueryRoute(useGetPodQuery, ({ data }) => {
      const pod = data?.pod;

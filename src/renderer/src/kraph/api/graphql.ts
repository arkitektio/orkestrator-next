...
/** An activity representing provenance information */
...
export type CategoryTagOrder = { id: Ordering; name?: never } | { id?: never; name: Ordering }
...
export type CreateEntityInput = {
  ...
  /** List of property key-value pairs to associate with this entity */
  stickyProperties?: Array<PropertySet>
...
export type EdgePairsQueryOrder = { id: Ordering; label?: never } | { id?: never; label: Ordering }
...
export type EdgePathQueryOrder = { id: Ordering; label?: never } | { id?: never; label: Ordering }
...
/** Base interface for graph schemas */
export type EdgeTableQuery = EdgeQuery &
  Plottable & {
...
export type EdgeTableQueryOrder = { id: Ordering; label?: never } | { id?: never; label: Ordering }
...
/** Interface for edges that track schema version and derivation time */
export type Event = {
  /** The event type/kind */
  kind: Scalars['String']['output']
}
...
export type GraphNodesQueryOrder = { id: Ordering; label?: never } | { id?: never; label: Ordering }
...
export type GraphOrder = { id: Ordering; name?: never } | { id?: never; name: Ordering }
...
export type GraphPairsQueryOrder = { id: Ordering; label?: never } | { id?: never; label: Ordering }
...
/** Base interface for graph schemas */
export type GraphTableQuery = GraphQuery &
  Plottable & {
...
export type GraphTableQueryOrder = { id: Ordering; label?: never } | { id?: never; label: Ordering }
...
export type MaterializedEdgeOrder = { id: Ordering }
...
export type MeasurementCategory = Category &
  EdgeCategory & {
...
export type MetricCategory = Category &
  NodeCategory & {
...
export type NaturalEvent = Event &
  Node &
  VersionedNode & {
...
export type NaturalEventCategory = Category &
  EventCategory &
  NodeCategory & {
...
export type NodeFilters = {
  /** Filter nodes that have a specific property */
  hasProperty?: InputMaybe<Scalars['String']['input']>
  /** Filter by specific node IDs */
  ids?: InputMaybe<Array<Scalars['GraphID']['input']>>
  /** Filter nodes that match specific property conditions */
  matches?: InputMaybe<Array<PropertyMatch>>
...
export type NodePairsQueryOrder = { id: Ordering; label?: never } | { id?: never; label: Ordering }
...
export type NodePathQueryOrder = { id: Ordering; label?: never } | { id?: never; label: Ordering }
...
/** Base interface for graph schemas */
export type NodeTableQuery = NodeQuery &
  Plottable & {
...
export type NodeTableQueryOrder = { id: Ordering; label?: never } | { id?: never; label: Ordering }
...
/** A relation category/schema definition */
export type ProtocolEventCategory = Category &
  EventCategory &
  NodeCategory & {
...
export type Query = {
  ...
  _service: _Service
  /** List activities in a graph with optional filters, ordering, and pagination */
  ...
  graphs: Array<Graph>
  /** Get an input participation edge by composite graph ID */
  ...
  nodes: Array<Node>
  /** Get an output participation edge by composite graph ID */
...
/** A relation category/schema definition */
export type RelationCategory = Category &
  EdgeCategory & {
...
export type ScatterPlotOrder = { id: Ordering; name?: never } | { id?: never; name: Ordering }
...
export type StructureCategory = Category &
  NodeCategory & {
...
/** A relation category/schema definition */
export type StructureRelationCategory = Category &
  EdgeCategory & {
...
type BaseNode_Activity_Fragment = {
  __typename?: 'Activity'
  id: string
  label: string
  graph: { __typename?: 'Graph'; id: string }
}

type BaseNode_Entity_Fragment = {
  __typename?: 'Entity'
  id: string
  label: string
  graph: { __typename?: 'Graph'; id: string }
...
type BaseNode_MeasurementShadowLink_Fragment = {
  __typename?: 'MeasurementShadowLink'
  id: string
  label: string
  graph: { __typename?: 'Graph'; id: string }
...
type BaseNode_NaturalEvent_Fragment = {
  __typename?: 'NaturalEvent'
  id: string
  label: string
  graph: { __typename?: 'Graph'; id: string }
...
type BaseNode_ProtocolEvent_Fragment = {
  __typename?: 'ProtocolEvent'
  id: string
  label: string
  graph: { __typename?: 'Graph'; id: string }
...
type BaseNode_RelationShadowLink_Fragment = {
  __typename?: 'RelationShadowLink'
  id: string
  label: string
  graph: { __typename?: 'Graph'; id: string }
...
type BaseNode_StructureRelationShadowLink_Fragment = {
  __typename?: 'StructureRelationShadowLink'
  id: string
  label: string
  graph: { __typename?: 'Graph'; id: string }
...
export type BaseNodeFragment =
  | BaseNode_Activity_Fragment
  | BaseNode_Entity_Fragment
  | BaseNode_MeasurementShadowLink_Fragment
  | BaseNode_Metric_Fragment
  | BaseNode_NaturalEvent_Fragment
  | BaseNode_ProtocolEvent_Fragment
  | BaseNode_RelationShadowLink_Fragment
  | BaseNode_Structure_Fragment
  | BaseNode_StructureRelationShadowLink_Fragment

type Node_Activity_Fragment = {
  __typename?: 'Activity'
  id: string
  label: string
  graph: { __typename?: 'Graph'; id: string }
...
type Node_Entity_Fragment = {
  ...
  category: {
    ...
    propertyDefinitions: Array<{
      ...
      label?: string | null
      rule?: { __typename?: 'DerivationRule'; aggregation?: AggregationFunction | null } | null
    }>
  }
  richProperties: Array<{ __typename?: 'RichProperty'; key?: string | null; value?: any | null }>
  measuredBy: Array<{
    __typename?: 'Measurement'
    id: string
    category: { __typename?: 'MeasurementCategory'; label: string }
    source: { __typename?: 'Structure'; identifier: any; object: string }
  }>
  participatedIn: Array<{
    ...
    target:
      | {
          ...
          measuredFrom: any
          measuredTo: any
          category: { __typename?: 'NaturalEventCategory'; label: string }
        }
      | {
          __typename?: 'ProtocolEvent'
          id: string
          ...
          measuredFrom: any
          measuredTo: any
          category: { __typename?: 'ProtocolEventCategory'; label: string }
        }
  }>
  resultedOut: Array<{
    __typename?: 'OutputParticipation'
...
type Node_MeasurementShadowLink_Fragment = {
  __typename?: 'MeasurementShadowLink'
  id: string
  label: string
  graph: { __typename?: 'Graph'; id: string }
...
type Node_RelationShadowLink_Fragment = {
  __typename?: 'RelationShadowLink'
  id: string
  label: string
  graph: { __typename?: 'Graph'; id: string }
...
type Node_Structure_Fragment = {
  ...
  category: {
    ...
    image?: { __typename?: 'MediaStore'; presignedUrl: string } | null
    tags: Array<{
      __typename?: 'CategoryTag'
      id: string
      name: string
  ...
  metrics: Array<{
    ...
    id: string
    value: any
    category: { __typename?: 'MetricCategory'; label: string }
  }>
}

type Node_StructureRelationShadowLink_Fragment = {
  __typename?: 'StructureRelationShadowLink'
  id: string
  label: string
  graph: { __typename?: 'Graph'; id: string }
...
export type NodeFragment =
  | Node_Activity_Fragment
  | Node_Entity_Fragment
  | Node_MeasurementShadowLink_Fragment
  | Node_Metric_Fragment
  | Node_NaturalEvent_Fragment
  | Node_ProtocolEvent_Fragment
  | Node_RelationShadowLink_Fragment
  | Node_Structure_Fragment
  | Node_StructureRelationShadowLink_Fragment

type DetailNode_Activity_Fragment = {
  __typename?: 'Activity'
  id: string
  label: string
  graph: { __typename?: 'Graph'; id: string; name: string }
...
type DetailNode_MeasurementShadowLink_Fragment = {
  __typename?: 'MeasurementShadowLink'
  id: string
  label: string
  graph: { __typename?: 'Graph'; id: string; name: string }
...
type DetailNode_Metric_Fragment = {
  __typename?: 'Metric'
  id: string
  label: string
  value: any
...
type DetailNode_NaturalEvent_Fragment = {
  __typename?: 'NaturalEvent'
  id: string
  label: string
  graph: { __typename?: 'Graph'; id: string; name: string }
...
type DetailNode_RelationShadowLink_Fragment = {
  __typename?: 'RelationShadowLink'
  id: string
  label: string
  graph: { __typename?: 'Graph'; id: string; name: string }
...
type DetailNode_Structure_Fragment = {
  __typename?: 'Structure'
  id: string
  label: string
  object: string
...
type DetailNode_StructureRelationShadowLink_Fragment = {
  __typename?: 'StructureRelationShadowLink'
  id: string
  label: string
  graph: { __typename?: 'Graph'; id: string; name: string }
...
export type DetailNodeFragment =
  | DetailNode_Activity_Fragment
  | DetailNode_Entity_Fragment
  | DetailNode_MeasurementShadowLink_Fragment
  | DetailNode_Metric_Fragment
  | DetailNode_NaturalEvent_Fragment
  | DetailNode_ProtocolEvent_Fragment
  | DetailNode_RelationShadowLink_Fragment
  | DetailNode_Structure_Fragment
  | DetailNode_StructureRelationShadowLink_Fragment

export type PathRelationShadowLinkFragment = {
  __typename?: 'RelationShadowLink'
  id: string
  label: string
}

export type PathStructureRelationShadowLinkFragment = {
  __typename?: 'StructureRelationShadowLink'
  id: string
  label: string
}

export type PathMeasurementRelationShadowLinkFragment = {
  __typename?: 'MeasurementShadowLink'
  id: string
  label: string
}
...
export type PathStructureFragment = {
  __typename?: 'Structure'
  id: string
  label: string
  category: { __typename?: 'StructureCategory'; id: string; label: string }
}

type PathNode_Activity_Fragment = { __typename?: 'Activity'; id: string; label: string }

type PathNode_Entity_Fragment = {
  __typename?: 'Entity'
  id: string
...
type PathNode_MeasurementShadowLink_Fragment = {
  __typename?: 'MeasurementShadowLink'
  id: string
  label: string
}

type PathNode_Metric_Fragment = {
  __typename?: 'Metric'
  id: string
  value: any
  label: string
...
type PathNode_NaturalEvent_Fragment = {
  __typename?: 'NaturalEvent'
  id: string
  measuredFrom: any
  measuredTo: any
...
type PathNode_ProtocolEvent_Fragment = {
  __typename?: 'ProtocolEvent'
  id: string
  measuredFrom: any
  measuredTo: any
  ...
  richProperties: Array<{ __typename?: 'RichProperty'; value?: any | null }>
}

type PathNode_RelationShadowLink_Fragment = {
  __typename?: 'RelationShadowLink'
  id: string
  label: string
}

type PathNode_Structure_Fragment = {
  __typename?: 'Structure'
  id: string
  label: string
  category: { __typename?: 'StructureCategory'; id: string; label: string }
...
type PathNode_StructureRelationShadowLink_Fragment = {
  __typename?: 'StructureRelationShadowLink'
  id: string
  label: string
}

export type PathNodeFragment =
  | PathNode_Activity_Fragment
  | PathNode_Entity_Fragment
  | PathNode_MeasurementShadowLink_Fragment
  | PathNode_Metric_Fragment
  | PathNode_NaturalEvent_Fragment
  | PathNode_ProtocolEvent_Fragment
  | PathNode_RelationShadowLink_Fragment
  | PathNode_Structure_Fragment
...
type ListNode_MeasurementShadowLink_Fragment = {
  __typename?: 'MeasurementShadowLink'
  id: string
  label: string
}
...
type ListNode_RelationShadowLink_Fragment = {
  __typename?: 'RelationShadowLink'
  id: string
  label: string
}
...
type ListNode_StructureRelationShadowLink_Fragment = {
  __typename?: 'StructureRelationShadowLink'
  id: string
  label: string
}

export type ListNodeFragment =
  | ListNode_Activity_Fragment
  | ListNode_Entity_Fragment
  | ListNode_MeasurementShadowLink_Fragment
  | ListNode_Metric_Fragment
  | ListNode_NaturalEvent_Fragment
  | ListNode_ProtocolEvent_Fragment
  | ListNode_RelationShadowLink_Fragment
  | ListNode_Structure_Fragment
  | ListNode_StructureRelationShadowLink_Fragment
...
type BaseEdge_Assertion_Fragment = {
  __typename?: 'Assertion'
  id: string
  sourceId: string
  targetId: string
...
type BaseEdge_Description_Fragment = {
  __typename?: 'Description'
  id: string
  sourceId: string
  targetId: string
...
type BaseEdge_InputParticipation_Fragment = {
  __typename?: 'InputParticipation'
  id: string
  sourceId: string
  targetId: string
...
type BaseEdge_Measurement_Fragment = {
  __typename?: 'Measurement'
  id: string
  sourceId: string
  targetId: string
...
type BaseEdge_OutputParticipation_Fragment = {
  __typename?: 'OutputParticipation'
  id: string
  sourceId: string
  targetId: string
...
type BaseEdge_Relation_Fragment = {
  __typename?: 'Relation'
  id: string
  sourceId: string
  targetId: string
...
type BaseEdge_StructureRelation_Fragment = {
  __typename?: 'StructureRelation'
  id: string
  sourceId: string
  targetId: string
...
export type BaseEdgeFragment =
  | BaseEdge_Assertion_Fragment
...
export type MeasurementFragment = {
  __typename?: 'Measurement'
  category: { __typename?: 'MeasurementCategory'; id: string; label: string }
}

export type RelationFragment = {
  __typename?: 'Relation'
  category: { __typename?: 'RelationCategory'; id: string; label: string }
}
...
export type StructureRelationFragment = {
  ...
  sourceId: string
  targetId: string
  source: { __typename?: 'Structure'; id: string; label: string }
  target: { __typename?: 'Structure'; id: string; label: string }
  category: { __typename?: 'StructureRelationCategory'; id: string; label: string }
}

type Edge_Assertion_Fragment = {
  __typename?: 'Assertion'
  sourceId: string
  targetId: string
  id: string
...
export type EdgeFragment =
  | Edge_Assertion_Fragment
...
export type PathMeasurementFragment = {
  __typename?: 'Measurement'
  id: string
  label: string
  category: { __typename?: 'MeasurementCategory'; id: string; label: string }
...
export type PathStructureRelationFragment = {
  __typename?: 'StructureRelation'
  id: string
  label: string
  category: { __typename?: 'StructureRelationCategory'; id: string; label: string }
...
export type PathRelationFragment = {
  __typename?: 'Relation'
  id: string
  label: string
  category: { __typename?: 'RelationCategory'; id: string; label: string }
...
export type PathAssertionFragment = { __typename?: 'Assertion'; id: string; label: string }

export type PathDescriptionFragment = { __typename?: 'Description'; id: string; label: string }

export type PathInputParticipationFragment = {
  __typename?: 'InputParticipation'
  id: string
  label: string
}

export type PathOutputParticipationFragment = {
  __typename?: 'OutputParticipation'
  id: string
  label: string
}

type PathEdge_Assertion_Fragment = {
  __typename?: 'Assertion'
  sourceId: string
  targetId: string
  id: string
...
type PathEdge_Description_Fragment = {
  __typename?: 'Description'
  sourceId: string
  targetId: string
  id: string
...
type PathEdge_InputParticipation_Fragment = {
  __typename?: 'InputParticipation'
  sourceId: string
  targetId: string
  id: string
...
type PathEdge_Measurement_Fragment = {
  __typename?: 'Measurement'
  sourceId: string
  targetId: string
  id: string
...
type PathEdge_OutputParticipation_Fragment = {
  __typename?: 'OutputParticipation'
  sourceId: string
  targetId: string
  id: string
...
type PathEdge_Relation_Fragment = {
  __typename?: 'Relation'
  sourceId: string
  targetId: string
  id: string
...
type PathEdge_StructureRelation_Fragment = {
  __typename?: 'StructureRelation'
  sourceId: string
  targetId: string
  id: string
...
export type PathEdgeFragment =
  | PathEdge_Assertion_Fragment
  | PathEdge_Description_Fragment
  | PathEdge_InputParticipation_Fragment
  | PathEdge_Measurement_Fragment
  | PathEdge_OutputParticipation_Fragment
  | PathEdge_Relation_Fragment
  | PathEdge_StructureRelation_Fragment
...
export type PathEntityFragment = {
  __typename?: 'Entity'
  externalId?: string | null
  id: string
  label: string
...
export type ListEntityFragment = {
  __typename?: 'Entity'
  id: string
  label: string
  category: { __typename?: 'EntityCategory'; id: string; label: string }
}

type BaseEdgeQuery_EdgePairsQuery_Fragment = {
  __typename?: 'EdgePairsQuery'
  id: string
  label: string
  description?: string | null
...
type BaseEdgeQuery_EdgePathQuery_Fragment = {
  __typename?: 'EdgePathQuery'
  id: string
  label: string
  description?: string | null
...
type BaseEdgeQuery_EdgeTableQuery_Fragment = {
  __typename?: 'EdgeTableQuery'
  id: string
  label: string
  description?: string | null
...
export type BaseEdgeQueryFragment =
  | BaseEdgeQuery_EdgePairsQuery_Fragment
  | BaseEdgeQuery_EdgePathQuery_Fragment
  | BaseEdgeQuery_EdgeTableQuery_Fragment

type ListEdgeQuery_EdgePairsQuery_Fragment = {
  __typename: 'EdgePairsQuery'
  id: string
  label: string
  description?: string | null
...
type ListEdgeQuery_EdgePathQuery_Fragment = {
  __typename: 'EdgePathQuery'
  id: string
  label: string
  description?: string | null
...
type ListEdgeQuery_EdgeTableQuery_Fragment = {
  __typename: 'EdgeTableQuery'
  id: string
  label: string
  description?: string | null
...
export type ListEdgeQueryFragment =
  | ListEdgeQuery_EdgePairsQuery_Fragment
  | ListEdgeQuery_EdgePathQuery_Fragment
  | ListEdgeQuery_EdgeTableQuery_Fragment

type EdgeQuery_EdgePairsQuery_Fragment = {
  __typename?: 'EdgePairsQuery'
  id: string
  label: string
  description?: string | null
...
type EdgeQuery_EdgePathQuery_Fragment = {
  __typename?: 'EdgePathQuery'
  id: string
  label: string
  description?: string | null
...
type EdgeQuery_EdgeTableQuery_Fragment = {
  __typename?: 'EdgeTableQuery'
  id: string
  label: string
  description?: string | null
  ...
  builderArgs?: {
    ...
    matchPaths?: Array<{
      ...
      relationDirections?: Array<boolean> | null
      title?: string | null
...
export type EdgeQueryFragment =
  | EdgeQuery_EdgePairsQuery_Fragment
  | EdgeQuery_EdgePathQuery_Fragment
  | EdgeQuery_EdgeTableQuery_Fragment

export type EdgeTableQueryFragment = {
  __typename?: 'EdgeTableQuery'
  id: string
  label: string
  description?: string | null
...
export type GraphPathRenderFragment = {
  __typename?: 'GraphPathRender'
  query: {
    __typename?: 'GraphPathQuery'
  ...
  nodes: Array<
    | { __typename?: 'Activity'; id: string; label: string }
    | {
        __typename?: 'Entity'
        id: string
        externalId?: string | null
    ...
    | { __typename?: 'MeasurementShadowLink'; id: string; label: string }
    | {
        __typename?: 'Metric'
        id: string
        value: any
    ...
    | { __typename?: 'RelationShadowLink'; id: string; label: string }
    | {
        __typename?: 'Structure'
        id: string
        label: string
    ...
    | { __typename?: 'StructureRelationShadowLink'; id: string; label: string }
  >
  edges: Array<
    | { __typename?: 'Assertion'; sourceId: string; targetId: string; id: string; label: string }
    | { __typename?: 'Description'; sourceId: string; targetId: string; id: string; label: string }
    | {
        __typename?: 'InputParticipation'
        sourceId: string
        targetId: string
...
type BaseGraphQuery_GraphNodesQuery_Fragment = {
  __typename?: 'GraphNodesQuery'
  id: string
  label: string
  description?: string | null
...
type BaseGraphQuery_GraphPairsQuery_Fragment = {
  __typename?: 'GraphPairsQuery'
  id: string
  label: string
  description?: string | null
...
type BaseGraphQuery_GraphPathQuery_Fragment = {
  __typename?: 'GraphPathQuery'
  id: string
  label: string
  description?: string | null
...
type BaseGraphQuery_GraphTableQuery_Fragment = {
  __typename?: 'GraphTableQuery'
  id: string
  label: string
  description?: string | null
...
export type BaseGraphQueryFragment =
  | BaseGraphQuery_GraphNodesQuery_Fragment
  | BaseGraphQuery_GraphPairsQuery_Fragment
  | BaseGraphQuery_GraphPathQuery_Fragment
  | BaseGraphQuery_GraphTableQuery_Fragment

type ListGraphQuery_GraphNodesQuery_Fragment = {
  __typename: 'GraphNodesQuery'
  id: string
  label: string
  description?: string | null
...
type ListGraphQuery_GraphPairsQuery_Fragment = {
  __typename: 'GraphPairsQuery'
  id: string
  label: string
  description?: string | null
...
type ListGraphQuery_GraphPathQuery_Fragment = {
  __typename: 'GraphPathQuery'
  id: string
  label: string
  description?: string | null
...
type ListGraphQuery_GraphTableQuery_Fragment = {
  __typename: 'GraphTableQuery'
  id: string
  label: string
  description?: string | null
...
export type ListGraphQueryFragment =
  | ListGraphQuery_GraphNodesQuery_Fragment
  | ListGraphQuery_GraphPairsQuery_Fragment
  | ListGraphQuery_GraphPathQuery_Fragment
  | ListGraphQuery_GraphTableQuery_Fragment

type GraphQuery_GraphNodesQuery_Fragment = {
  __typename?: 'GraphNodesQuery'
  id: string
  label: string
  description?: string | null
...
type GraphQuery_GraphPairsQuery_Fragment = {
  __typename?: 'GraphPairsQuery'
  id: string
  label: string
  description?: string | null
...
type GraphQuery_GraphPathQuery_Fragment = {
  __typename?: 'GraphPathQuery'
  id: string
  label: string
  description?: string | null
...
type GraphQuery_GraphTableQuery_Fragment = {
  __typename?: 'GraphTableQuery'
  id: string
  label: string
  description?: string | null
...
export type GraphQueryFragment =
  | GraphQuery_GraphNodesQuery_Fragment
  | GraphQuery_GraphPairsQuery_Fragment
  | GraphQuery_GraphPathQuery_Fragment
  | GraphQuery_GraphTableQuery_Fragment
...
export type GraphTableRenderFragment = {
  __typename?: 'GraphTableRender'
  rows: Array<any>
  query: {
    __typename?: 'GraphTableQuery'
...
type BaseNodeQuery_NodePairsQuery_Fragment = {
  __typename?: 'NodePairsQuery'
  id: string
  label: string
  description?: string | null
...
type BaseNodeQuery_NodePathQuery_Fragment = {
  __typename?: 'NodePathQuery'
  id: string
  label: string
  description?: string | null
...
type BaseNodeQuery_NodeTableQuery_Fragment = {
  __typename?: 'NodeTableQuery'
  id: string
  label: string
  description?: string | null
...
export type BaseNodeQueryFragment =
  | BaseNodeQuery_NodePairsQuery_Fragment
  | BaseNodeQuery_NodePathQuery_Fragment
  | BaseNodeQuery_NodeTableQuery_Fragment

type ListNodeQuery_NodePairsQuery_Fragment = {
  __typename: 'NodePairsQuery'
  id: string
  label: string
  description?: string | null
...
type ListNodeQuery_NodePathQuery_Fragment = {
  __typename: 'NodePathQuery'
  id: string
  label: string
  description?: string | null
...
type ListNodeQuery_NodeTableQuery_Fragment = {
  __typename: 'NodeTableQuery'
  id: string
  label: string
  description?: string | null
...
export type ListNodeQueryFragment =
  | ListNodeQuery_NodePairsQuery_Fragment
  | ListNodeQuery_NodePathQuery_Fragment
  | ListNodeQuery_NodeTableQuery_Fragment

type NodeQuery_NodePairsQuery_Fragment = {
  __typename?: 'NodePairsQuery'
  id: string
  label: string
  description?: string | null
...
type NodeQuery_NodePathQuery_Fragment = {
  __typename?: 'NodePathQuery'
  id: string
  label: string
  description?: string | null
...
type NodeQuery_NodeTableQuery_Fragment = {
  __typename?: 'NodeTableQuery'
  id: string
  label: string
  description?: string | null
...
export type NodeQueryFragment =
  | NodeQuery_NodePairsQuery_Fragment
  | NodeQuery_NodePathQuery_Fragment
  | NodeQuery_NodeTableQuery_Fragment

export type NodeTableQueryFragment = {
  __typename?: 'NodeTableQuery'
  id: string
  label: string
  description?: string | null
...
export type ScatterPlotFragment = {
  __typename?: 'ScatterPlot'
  id: string
  label: string
  description?: string | null
...
export type ListScatterPlotFragment = {
  __typename?: 'ScatterPlot'
  id: string
  label: string
  xColumn: string
...
export type ReturnStatementFragment = {
  __typename?: 'ReturnStatement'
  path: string
  property?: string | null
  node?: string | null
...
export type BuilderArgsFragment = {
  __typename?: 'BuilderArgs'
  matchPaths?: Array<{
    __typename?: 'MatchPath'
    nodes: Array<string>
...
export type PathMetricFragment = {
  __typename?: 'Metric'
  value: any
  id: string
  label: string
...
export type ListNaturalEventFragment = {
  __typename?: 'NaturalEvent'
  id: string
  measuredFrom: any
  measuredTo: any
  category: { __typename?: 'NaturalEventCategory'; label: string; id: string }
}
...
export type PropertyDefinitionFragment = {
  __typename?: 'PropertyDefinition'
  key: string
  valueKind: ValueKind
  description?: string | null
...
export type ListProtocolEventFragment = {
  __typename?: 'ProtocolEvent'
  id: string
  measuredFrom: any
  measuredTo: any
  category: { __typename?: 'ProtocolEventCategory'; label: string; id: string }
}
...
type BaseCategory_EntityCategory_Fragment = {
  __typename?: 'EntityCategory'
  id: string
  purl?: string | null
  ageName: string
  graph: { __typename?: 'Graph'; id: string }
  tags: Array<{ __typename?: 'CategoryTag'; id: string; name: string; description?: string | null }>
  relevantQueries: Array<
    | {
        __typename: 'GraphNodesQuery'
        id: string
...
type BaseCategory_MeasurementCategory_Fragment = {
  __typename?: 'MeasurementCategory'
  id: string
  purl?: string | null
  ageName: string
...
type BaseCategory_MetricCategory_Fragment = {
  __typename?: 'MetricCategory'
  id: string
  purl?: string | null
  ageName: string
...
type BaseCategory_NaturalEventCategory_Fragment = {
  __typename?: 'NaturalEventCategory'
  id: string
  purl?: string | null
  ageName: string
...
type BaseCategory_ProtocolEventCategory_Fragment = {
  __typename?: 'ProtocolEventCategory'
  id: string
  purl?: string | null
  ageName: string
...
type BaseCategory_RelationCategory_Fragment = {
  __typename?: 'RelationCategory'
  id: string
  purl?: string | null
  ageName: string
...
type BaseCategory_StructureCategory_Fragment = {
  __typename?: 'StructureCategory'
  id: string
  purl?: string | null
  ageName: string
...
type BaseCategory_StructureRelationCategory_Fragment = {
  __typename?: 'StructureRelationCategory'
  id: string
  purl?: string | null
  ageName: string
...
export type BaseCategoryFragment =
  ...
  | BaseCategory_StructureCategory_Fragment
  | BaseCategory_StructureRelationCategory_Fragment

type BaseNodeCategory_EntityCategory_Fragment = {
  __typename?: 'EntityCategory'
  id: string
  positionX?: number | null
  positionY?: number | null
...
type BaseNodeCategory_MetricCategory_Fragment = {
  __typename?: 'MetricCategory'
  id: string
  positionX?: number | null
  positionY?: number | null
...
type BaseNodeCategory_ProtocolEventCategory_Fragment = {
  __typename?: 'ProtocolEventCategory'
  id: string
  positionX?: number | null
  positionY?: number | null
...
type BaseNodeCategory_StructureCategory_Fragment = {
  __typename?: 'StructureCategory'
  id: string
  positionX?: number | null
  positionY?: number | null
...
type BaseEdgeCategory_StructureRelationCategory_Fragment = {
  __typename?: 'StructureRelationCategory'
  id: string
}

export type BaseEdgeCategoryFragment =
...
type NodeCategory_MetricCategory_Fragment = {
  __typename?: 'MetricCategory'
  ageName: string
  label: string
  valueKind: ValueKind
...
type NodeCategory_NaturalEventCategory_Fragment = {
  ...
  inputs: Array<{
    ...
    descriptor: {
      ...
      ontotologyTerms?: Array<string> | null
...
export type NodeCategoryFragment =
  | NodeCategory_EntityCategory_Fragment
  | NodeCategory_MetricCategory_Fragment
  | NodeCategory_NaturalEventCategory_Fragment
  | NodeCategory_ProtocolEventCategory_Fragment
  | NodeCategory_StructureCategory_Fragment
...
export type ListEntityCategoryFragment = {
  ...
  height?: number | null
  image?: { __typename?: 'MediaStore'; presignedUrl: string } | null
  tags: Array<{ __typename?: 'CategoryTag'; id: string; name: string }>
  relevantNodeQueries: Array<
    | {
        __typename: 'NodePairsQuery'
        id: string
...
export type ListMaterializedEdgeFragment = {
  __typename?: 'MaterializedEdge'
  id: string
  source:
    | { __typename?: 'EntityCategory'; id: string }
    | { __typename?: 'MetricCategory'; id: string }
    | { __typename?: 'NaturalEventCategory'; id: string }
    | { __typename?: 'ProtocolEventCategory'; id: string }
    | { __typename?: 'StructureCategory'; id: string }
  target:
    | { __typename?: 'EntityCategory'; id: string; label: string }
    | { __typename?: 'MetricCategory'; id: string; label: string }
    | { __typename?: 'NaturalEventCategory'; id: string; label: string }
    | { __typename?: 'ProtocolEventCategory'; id: string; label: string }
    | { __typename?: 'StructureCategory'; id: string; label: string }
  edge:
    | { __typename?: 'MeasurementCategory'; id: string; label: string; description?: string | null }
    | { __typename?: 'RelationCategory'; id: string; label: string; description?: string | null }
    | {
        __typename?: 'StructureRelationCategory'
        id: string
        label: string
...
export type GraphFragment = {
  ...
  metricCategories: Array<{
    ...
    width?: number | null
    height?: number | null
    structureCategory: { __typename?: 'StructureCategory'; id: string; identifier: string }
    image?: { __typename?: 'MediaStore'; presignedUrl: string } | null
    tags: Array<{ __typename?: 'CategoryTag'; id: string; name: string }>
    relevantNodeQueries: Array<
      | {
  ...
  >
  image?: { __typename?: 'MediaStore'; id: string; presignedUrl: string; key: string } | null
  materializedEdges: Array<{
    __typename?: 'MaterializedEdge'
    id: string
    source:
      | { __typename?: 'EntityCategory'; id: string }
...
type BaseListCategory_EntityCategory_Fragment = {
  __typename?: 'EntityCategory'
  id: string
  description?: string | null
  ageName: string
...
type BaseListCategory_MetricCategory_Fragment = {
  __typename?: 'MetricCategory'
  id: string
  description?: string | null
  ageName: string
...
type BaseListCategory_NaturalEventCategory_Fragment = {
  __typename?: 'NaturalEventCategory'
  id: string
  description?: string | null
  ageName: string
...
type BaseListCategory_StructureCategory_Fragment = {
  __typename?: 'StructureCategory'
  id: string
  description?: string | null
  ageName: string
...
type BaseListCategory_StructureRelationCategory_Fragment = {
  __typename?: 'StructureRelationCategory'
  id: string
  description?: string | null
  ageName: string
...
export type BaseListCategoryFragment =
  ...
  | BaseListCategory_MetricCategory_Fragment
...
type BaseListNodeCategory_EntityCategory_Fragment = {
  __typename?: 'EntityCategory'
  id: string
  positionX?: number | null
  positionY?: number | null
...
type BaseListNodeCategory_MetricCategory_Fragment = {
  __typename?: 'MetricCategory'
  id: string
  positionX?: number | null
  positionY?: number | null
...
type BaseListNodeCategory_NaturalEventCategory_Fragment = {
  __typename?: 'NaturalEventCategory'
  id: string
  positionX?: number | null
  positionY?: number | null
...
type BaseListNodeCategory_ProtocolEventCategory_Fragment = {
  __typename?: 'ProtocolEventCategory'
  id: string
  positionX?: number | null
  positionY?: number | null
...
type BaseListNodeCategory_StructureCategory_Fragment = {
  __typename?: 'StructureCategory'
  id: string
  positionX?: number | null
  positionY?: number | null
...
export type BaseListNodeCategoryFragment =
  | BaseListNodeCategory_EntityCategory_Fragment
  | BaseListNodeCategory_MetricCategory_Fragment
  | BaseListNodeCategory_NaturalEventCategory_Fragment
  | BaseListNodeCategory_ProtocolEventCategory_Fragment
  | BaseListNodeCategory_StructureCategory_Fragment

type BaseListEdgeCategory_MeasurementCategory_Fragment = {
  __typename?: 'MeasurementCategory'
  id: string
}
...
type BaseListEdgeCategory_StructureRelationCategory_Fragment = {
  __typename?: 'StructureRelationCategory'
  id: string
}

export type BaseListEdgeCategoryFragment =
...
export type MaterializedEdgeFragment = {
  __typename?: 'MaterializedEdge'
  id: string
  graph: { __typename?: 'Graph'; id: string; name: string }
  source:
    | { __typename?: 'EntityCategory'; id: string; label: string; description?: string | null }
    | { __typename?: 'MetricCategory'; id: string; label: string; description?: string | null }
    | {
        __typename?: 'NaturalEventCategory'
        id: string
        label: string
    ...
    | { __typename?: 'StructureCategory'; id: string; label: string; description?: string | null }
  target:
    | { __typename?: 'EntityCategory'; id: string; label: string; description?: string | null }
    | { __typename?: 'MetricCategory'; id: string; label: string; description?: string | null }
    | {
...
export type MetricCategoryFragment = {
  __typename?: 'MetricCategory'
  ageName: string
  label: string
  valueKind: ValueKind
...
export type EntityDescriptorFragment = {
  __typename?: 'EntityDescriptor'
  keys?: Array<string> | null
  tags?: Array<string> | null
  ontotologyTerms?: Array<string> | null
...
export type StructureDescriptorFragment = {
  __typename?: 'StructureDescriptor'
  keys?: Array<string> | null
  tags?: Array<string> | null
  ontotologyTerms?: Array<string> | null
...
export type ListStructureCategoryFragment = {
  __typename?: 'StructureCategory'
  identifier: string
  description?: string | null
  id: string
...
export type ListStructureRelationCategoryWithGraphFragment = {
  ...
  description?: string | null
  ageName: string
  graph: { __typename?: 'Graph'; id: string; name: string; description?: string | null }
  sourceDescriptor: {
    __typename?: 'StructureDescriptor'
    keys?: Array<string> | null
    tags?: Array<string> | null
...
export type ListStructureFragment = {
  __typename?: 'Structure'
  id: string
  category: { __typename?: 'StructureCategory'; identifier: string; id: string }
}
...
export type InformedStructureFragment = {
  ...
  id: string
  label: string
  category: { __typename?: 'StructureCategory'; id: string; identifier: string }
  graph: { __typename?: 'Graph'; id: string; name: string }
  metrics: Array<{
    __typename?: 'Metric'
    id: string
...
export type DetailStructureRelationFragment = {
  __typename?: 'StructureRelation'
  id: string
  measuredFrom?: any | null
  measuredTo?: any | null
  sourceId: string
  targetId: string
  category: { __typename?: 'StructureRelationCategory'; id: string; label: string }
  source: { __typename?: 'Structure'; identifier: any; object: string }
  target: { __typename?: 'Structure'; identifier: any; object: string }
}
...
export type CreateEntityInlineMutation = {
  __typename?: 'Mutation'
  result: { __typename?: 'Entity'; value: string; label: string }
}
...
export type CreateGraphTableQueryMutation = {
  __typename?: 'Mutation'
  createGraphTableQuery: {
    __typename?: 'GraphTableQuery'
    query: any
    id: string
    label: string
...
export type UpdateGraphTableQueryMutation = {
  __typename?: 'Mutation'
  updateGraphTableQuery: {
    __typename?: 'GraphTableQuery'
    query: any
    id: string
    label: string
...
export type DeleteGraphTableQueryMutation = {
  __typename?: 'Mutation'
  deleteGraphTableQuery: string
}
...
export type CreateNodeTableQueryMutation = {
  __typename?: 'Mutation'
...
export type UpdateNodeTableQueryMutation = {
  __typename?: 'Mutation'
  updateNodeTableQuery: {
    __typename?: 'NodeTableQuery'
    id: string
    label: string
    description?: string | null
...
export type ArchiveMetricMutation = {
  __typename?: 'Mutation'
  archiveMetric: {
    __typename?: 'Metric'
    id: string
...
export type CreateNaturalEventMutation = {
  __typename?: 'Mutation'
  createNaturalEvent: {
    __typename?: 'NaturalEvent'
    id: string
...
export type ArchiveNaturalEventMutation = {
  __typename?: 'Mutation'
  archiveNaturalEvent: {
    __typename?: 'NaturalEvent'
    id: string
...
export type UpdateNaturalEventMutation = {
  __typename?: 'Mutation'
  updateNaturalEvent: {
    __typename?: 'NaturalEvent'
    id: string
...
export type CreateProtocolEventMutation = {
  __typename?: 'Mutation'
  createProtocolEvent: {
    __typename?: 'ProtocolEvent'
    id: string
...
export type ArchiveProtocolEventMutation = {
  __typename?: 'Mutation'
  archiveProtocolEvent: {
    __typename?: 'ProtocolEvent'
    id: string
    measuredFrom: any
    label: string
...
export type UpdateProtocolEventMutation = {
  __typename?: 'Mutation'
  updateProtocolEvent: {
    __typename?: 'ProtocolEvent'
    id: string
...
export type ArchiveRelationMutation = {
  __typename?: 'Mutation'
  archiveRelation: {
    __typename?: 'Relation'
    category: { __typename?: 'RelationCategory'; id: string; label: string }
...
export type CreateInlineGraphMutation = {
  __typename?: 'Mutation'
  result: { __typename?: 'Graph'; value: string; label: string }
}
...
export type ArchiveGraphMutation = {
  __typename?: 'Mutation'
  archiveGraph: {
    __typename?: 'Graph'
    id: string
...
export type CreateMeasurementCategoryMutation = {
  __typename?: 'Mutation'
...
export type UpdateMeasurementCategoryMutation = {
  __typename?: 'Mutation'
...
export type DeleteMeasurementCategoryMutation = {
  __typename?: 'Mutation'
  deleteMeasurementCategory: string
}
...
export type CreateMetricCategoryMutation = {
  __typename?: 'Mutation'
...
export type UpdateMetricCategoryMutation = {
  __typename?: 'Mutation'
...
export type CreateNaturalEventCategoryMutation = {
  __typename?: 'Mutation'
...
export type UpdateNaturalEventCategoryMutation = {
  __typename?: 'Mutation'
...
export type DeleteNaturalEventCategoryMutation = {
  __typename?: 'Mutation'
  deleteNaturalEventCategory: string
}
...
export type CreateProtocolEventCategoryMutation = {
  __typename?: 'Mutation'
...
export type UpdateProtocolEventCategoryMutation = {
  __typename?: 'Mutation'
...
export type DeleteProtocolEventCategoryMutation = {
  __typename?: 'Mutation'
  deleteProtocolEventCategory: string
}
...
export type CreateRelationCategoryMutation = {
  __typename?: 'Mutation'
...
export type UpdateRelationCategoryMutation = {
  __typename?: 'Mutation'
...
export type DeleteRelationCategoryMutation = {
  __typename?: 'Mutation'
  deleteRelationCategory: string
}
...
export type CreateStructureCategoryMutation = {
  __typename?: 'Mutation'
...
export type UpdateStructureCategoryMutation = {
  __typename?: 'Mutation'
...
export type DeleteStructureCategoryMutation = {
  __typename?: 'Mutation'
  deleteStructureCategory: string
}
...
export type CreateStructureRelationCategoryMutation = {
  __typename?: 'Mutation'
...
export type DeleteStructureRelationCategoryMutation = {
  __typename?: 'Mutation'
  deleteStructureRelationCategory: string
}
...
export type EnsureStructureMutation = {
  __typename?: 'Mutation'
  ensureStructure: {
    __typename?: 'Structure'
    id: string
...
export type CreateGraphTagInlineMutation = {
  __typename?: 'Mutation'
  result: { __typename?: 'CategoryTag'; value: string; label: string }
}
...
export type SearchEntitiesQuery = {
  __typename?: 'Query'
  options: Array<{ __typename?: 'Entity'; value: string; label: string }>
}
...
export type SearchGraphsQuery = {
  __typename?: 'Query'
  options: Array<{ __typename?: 'Graph'; value: string; label: string }>
}
...
export type GetGraphTableQueryQuery = {
  __typename?: 'Query'
  graphTableQuery: {
    __typename?: 'GraphTableQuery'
    id: string
...
export type SearchGraphTableQueriesQuery = {
  __typename?: 'Query'
  options: Array<{ __typename?: 'GraphTableQuery'; value: string; label: string }>
}
...
export type ListGraphTableQueriesQuery = {
  __typename?: 'Query'
  graphTableQueries: Array<{
    __typename: 'GraphTableQuery'
    id: string
    label: string
    description?: string | null
...
export type RenderGraphPathQuery = {
  __typename?: 'Query'
  renderGraphPath?: {
    __typename?: 'GraphPathRender'
    query: {
...
export type RenderGraphTableQuery = {
  __typename?: 'Query'
  renderGraphTable?: {
    __typename?: 'GraphTableRender'
    rows: Array<any>
...
export type GetScatterPlotQuery = {
  __typename?: 'Query'
  scatterPlot: {
    __typename?: 'ScatterPlot'
    id: string
...
export type SearchScatterPlotsQuery = {
  __typename?: 'Query'
  options: Array<{ __typename?: 'ScatterPlot'; value: string; label: string }>
}
...
export type ListScatterPlotsQuery = {
  __typename?: 'Query'
  scatterPlots: Array<{
    __typename?: 'ScatterPlot'
    id: string
...
export type ListMaterializedEdgesQuery = {
  __typename?: 'Query'
  materializedEdges: Array<{
    __typename?: 'MaterializedEdge'
    id: string
...
export type GetMaterializedEdgeQuery = {
  __typename?: 'Query'
  materializedEdge: {
    __typename?: 'MaterializedEdge'
    id: string
...
export type SearchMeasurementsQuery = {
  __typename?: 'Query'
  options: Array<{ __typename?: 'Measurement'; value: string; label: string }>
}
...
export type SearchMetricsQuery = {
  __typename?: 'Query'
  options: Array<{ __typename?: 'Metric'; value: string; label: string }>
}
...
export type ListMetricsQuery = {
  __typename?: 'Query'
  metrics: Array<{ __typename?: 'Metric'; id: string; value: any; label: string }>
}
...
export type SearchNaturalEventsQuery = {
  __typename?: 'Query'
  options: Array<{ __typename?: 'NaturalEvent'; value: string; label: string }>
}
...
export type SearchNodesQuery = {
  __typename?: 'Query'
  options: Array<
    | { __typename?: 'Activity'; value: string; label: string }
    | { __typename?: 'Entity'; value: string; label: string }
    | { __typename?: 'MeasurementShadowLink'; value: string; label: string }
    | { __typename?: 'Metric'; value: string; label: string }
    | { __typename?: 'NaturalEvent'; value: string; label: string }
    | { __typename?: 'ProtocolEvent'; value: string; label: string }
    | { __typename?: 'RelationShadowLink'; value: string; label: string }
    | { __typename?: 'Structure'; value: string; label: string }
    | { __typename?: 'StructureRelationShadowLink'; value: string; label: string }
  >
}
...
export type ListNodesQuery = {
  ...
  nodes: Array<
    | { __typename?: 'Activity'; id: string; label: string }
    | { __typename?: 'Entity'; id: string; label: string }
    | { __typename?: 'MeasurementShadowLink'; id: string; label: string }
    | { __typename?: 'Metric'; id: string; label: string }
    | { __typename?: 'NaturalEvent'; id: string; label: string }
    | { __typename?: 'ProtocolEvent'; id: string; label: string }
    | { __typename?: 'RelationShadowLink'; id: string; label: string }
    | { __typename?: 'Structure'; id: string; label: string }
    | { __typename?: 'StructureRelationShadowLink'; id: string; label: string }
  >
}
...
export type GetProtocolEventQuery = {
  __typename?: 'Query'
  protocolEvent: {
    __typename?: 'ProtocolEvent'
    id: string
...
export type SearchProtocolEventsQuery = {
  __typename?: 'Query'
  options: Array<{ __typename?: 'ProtocolEvent'; value: string; label: string }>
}
...
export type SearchRelationsQuery = {
  __typename?: 'Query'
  options: Array<{ __typename?: 'Relation'; value: string; label: string }>
}
...
export type SearchEntityCategoryQuery = {
  __typename?: 'Query'
  options: Array<{ __typename?: 'EntityCategory'; value: string; label: string }>
}
...
export type ListEntityCategoryQuery = {
  __typename?: 'Query'
  entityCategories: Array<{
    __typename?: 'EntityCategory'
    instanceKind?: string | null
...
export type EntityNodesQuery = {
  __typename?: 'Query'
  entities: Array<{ __typename: 'Entity'; id: string; label: string; properties: any }>
}
...
export type EntityCategoryStatsQuery = {
  __typename?: 'Query'
  entityCategoryStats: { __typename?: 'EntityCategoryStats'; count: number }
}
...
export type HomePageStatsQuery = {
  __typename?: 'Query'
  graphStats: { __typename?: 'GraphStats'; count: number }
}
...
export type GetMeasurmentCategoryQuery = {
  __typename?: 'Query'
  measurementCategory: {
    __typename?: 'MeasurementCategory'
    ageName: string
...
export type SearchMeasurmentCategoryQuery = {
  __typename?: 'Query'
  options: Array<{ __typename?: 'MeasurementCategory'; value: string; label: string }>
}
...
export type ListMeasurmentCategoryQuery = {
  __typename?: 'Query'
  measurementCategories: Array<{
    __typename?: 'MeasurementCategory'
    label: string
...
export type GetMetricCategoryQuery = {
  __typename?: 'Query'
  metricCategory: {
    __typename?: 'MetricCategory'
    ageName: string
...
export type ListMetricCategoryQuery = {
  __typename?: 'Query'
  metricCategories: Array<{
    __typename?: 'MetricCategory'
    label: string
...
export type SearchMetricCategoryQuery = {
  __typename?: 'Query'
  options: Array<{ __typename?: 'MetricCategory'; value: string; label: string }>
}
...
export type GetNaturalEventCategoryQuery = {
  __typename?: 'Query'
  naturalEventCategory: {
    __typename?: 'NaturalEventCategory'
    label: string
...
export type SearchNaturalEventCategoriesQuery = {
  __typename?: 'Query'
  options: Array<{ __typename?: 'NaturalEventCategory'; value: string; label: string }>
}
...
export type ListNaturalEventCategoriesQuery = {
  __typename?: 'Query'
  naturalEventCategories: Array<{
    __typename?: 'NaturalEventCategory'
    label: string
...
export type GetProtocolEventCategoryQuery = {
  __typename?: 'Query'
  protocolEventCategory: {
    __typename?: 'ProtocolEventCategory'
    label: string
...
export type SearchProtocolEventCategoriesQuery = {
  __typename?: 'Query'
  options: Array<{ __typename?: 'ProtocolEventCategory'; value: string; label: string }>
}
...
export type ListProtocolEventCategoriesQuery = {
  __typename?: 'Query'
  protocolEventCategories: Array<{
    __typename?: 'ProtocolEventCategory'
    label: string
...
export type GetRelationCategoryQuery = {
  __typename?: 'Query'
  relationCategory: {
    __typename?: 'RelationCategory'
    ageName: string
...
export type SearchRelationCategoryQuery = {
  __typename?: 'Query'
  options: Array<{ __typename?: 'RelationCategory'; value: string; label: string }>
}
...
export type ListRelationCategoryQuery = {
  __typename?: 'Query'
  relationCategories: Array<{
    __typename?: 'RelationCategory'
    label: string
...
export type GetStructureRelationCategoryQuery = {
  __typename?: 'Query'
  structureRelationCategory: {
    __typename?: 'StructureRelationCategory'
    ageName: string
...
export type SearchStructureRelationCategoryQuery = {
  __typename?: 'Query'
  options: Array<{ __typename?: 'StructureRelationCategory'; value: string; label: string }>
}
...
export type StartPaneQuery = {
  __typename?: 'Query'
  entityCategories: Array<{ __typename?: 'EntityCategory'; id: string; label: string }>
  relationCategories: Array<{ __typename?: 'RelationCategory'; id: string; label: string }>
  structureCategories: Array<{ __typename?: 'StructureCategory'; id: string; identifier: string }>
  protocolEventCategories: Array<{
    __typename?: 'ProtocolEventCategory'
    id: string
    label: string
  }>
  naturalEventCategories: Array<{ __typename?: 'NaturalEventCategory'; id: string; label: string }>
}
...
export type SearchStructuresQuery = {
  __typename?: 'Query'
  options: Array<{ __typename?: 'Structure'; value: string; label: string }>
}
...
export type GetInformedStructureQuery = {
  __typename?: 'Query'
...
export type ListStructuresQuery = {
  __typename?: 'Query'
  structures: Array<{
    __typename?: 'Structure'
    id: string
...
export type SearchStructureCategoryQuery = {
  __typename?: 'Query'
  options: Array<{ __typename?: 'StructureCategory'; value: string; label: string }>
}
...
export type ListStructureCategoryQuery = {
  __typename?: 'Query'
  structureCategories: Array<{
    __typename?: 'StructureCategory'
    identifier: string
...
export type GetStructureRelationQuery = {
  __typename?: 'Query'
  structureRelation: {
    __typename?: 'StructureRelation'
    id: string
...
export type SearchStructureRelationsQuery = {
  __typename?: 'Query'
  options: Array<{ __typename?: 'StructureRelation'; value: string; label: string }>
}
...
export type SearchTagsQuery = {
  __typename?: 'Query'
  options: Array<{ __typename?: 'CategoryTag'; value: string; label: string }>
}
...
`
export const PathStructureRelationFragmentDoc = gql`
  fragment PathStructureRelation on StructureRelation {
    id
    label
    category {
      id
...
`
export const PathInputParticipationFragmentDoc = gql`
  fragment PathInputParticipation on InputParticipation {
    id
    label
  }
`
export const PathOutputParticipationFragmentDoc = gql`
  fragment PathOutputParticipation on OutputParticipation {
    id
    label
  }
`
...
export function useCreateEntityMutation(
  ...
  return ApolloReactHooks.useMutation<CreateEntityMutation, CreateEntityMutationVariables>(
...
export function useUpdateEntityMutation(
  ...
  const options = { ...defaultOptions, ...baseOptions }
  return ApolloReactHooks.useMutation<UpdateEntityMutation, UpdateEntityMutationVariables>(
...
`
export type CreateEntityInlineMutationFn = Apollo.MutationFunction<
  CreateEntityInlineMutation,
  CreateEntityInlineMutationVariables
>
 ...
 * });
 */
export function useCreateEntityInlineMutation(
  baseOptions?: ApolloReactHooks.MutationHookOptions<
    CreateEntityInlineMutation,
    CreateEntityInlineMutationVariables
  >
  ...
  return ApolloReactHooks.useMutation<
    CreateEntityInlineMutation,
    CreateEntityInlineMutationVariables
  >(CreateEntityInlineDocument, options)
}
...
export type CreateEntityInlineMutationOptions = Apollo.BaseMutationOptions<
  CreateEntityInlineMutation,
  CreateEntityInlineMutationVariables
>
export const ArchiveEntityDocument = gql`
  ...
  ${EntityFragmentDoc}
`
export type ArchiveEntityMutationFn = Apollo.MutationFunction<
 ...
 * });
 */
export function useArchiveEntityMutation(
  baseOptions?: ApolloReactHooks.MutationHookOptions<
    ArchiveEntityMutation,
    ArchiveEntityMutationVariables
  >
  ...
  const options = { ...defaultOptions, ...baseOptions }
  return ApolloReactHooks.useMutation<ArchiveEntityMutation, ArchiveEntityMutationVariables>(
...
export type ArchiveEntityMutationOptions = Apollo.BaseMutationOptions<
  ArchiveEntityMutation,
  ArchiveEntityMutationVariables
>
...
export const CreateGraphTableQueryDocument = gql`
  ...
  ${GraphTableQueryFragmentDoc}
`
export type CreateGraphTableQueryMutationFn = Apollo.MutationFunction<
  CreateGraphTableQueryMutation,
  CreateGraphTableQueryMutationVariables
>
 ...
 * });
 */
export function useCreateGraphTableQueryMutation(
  baseOptions?: ApolloReactHooks.MutationHookOptions<
    CreateGraphTableQueryMutation,
    CreateGraphTableQueryMutationVariables
  >
  ...
  return ApolloReactHooks.useMutation<
    CreateGraphTableQueryMutation,
    CreateGraphTableQueryMutationVariables
  >(CreateGraphTableQueryDocument, options)
}
export type CreateGraphTableQueryMutationHookResult = ReturnType<
  typeof useCreateGraphTableQueryMutation
>
export type CreateGraphTableQueryMutationResult =
  Apollo.MutationResult<CreateGraphTableQueryMutation>
export type CreateGraphTableQueryMutationOptions = Apollo.BaseMutationOptions<
  CreateGraphTableQueryMutation,
  CreateGraphTableQueryMutationVariables
>
export const UpdateGraphTableQueryDocument = gql`
  ...
  ${GraphTableQueryFragmentDoc}
`
export type UpdateGraphTableQueryMutationFn = Apollo.MutationFunction<
  UpdateGraphTableQueryMutation,
  UpdateGraphTableQueryMutationVariables
>
 ...
 * });
 */
export function useUpdateGraphTableQueryMutation(
  baseOptions?: ApolloReactHooks.MutationHookOptions<
    UpdateGraphTableQueryMutation,
    UpdateGraphTableQueryMutationVariables
  >
  ...
  return ApolloReactHooks.useMutation<
    UpdateGraphTableQueryMutation,
    UpdateGraphTableQueryMutationVariables
  >(UpdateGraphTableQueryDocument, options)
}
export type UpdateGraphTableQueryMutationHookResult = ReturnType<
  typeof useUpdateGraphTableQueryMutation
>
export type UpdateGraphTableQueryMutationResult =
  Apollo.MutationResult<UpdateGraphTableQueryMutation>
export type UpdateGraphTableQueryMutationOptions = Apollo.BaseMutationOptions<
  UpdateGraphTableQueryMutation,
  UpdateGraphTableQueryMutationVariables
>
...
`
export type DeleteGraphTableQueryMutationFn = Apollo.MutationFunction<
  DeleteGraphTableQueryMutation,
  DeleteGraphTableQueryMutationVariables
>
 ...
 * });
 */
export function useDeleteGraphTableQueryMutation(
  baseOptions?: ApolloReactHooks.MutationHookOptions<
    DeleteGraphTableQueryMutation,
    DeleteGraphTableQueryMutationVariables
  >
  ...
  return ApolloReactHooks.useMutation<
    DeleteGraphTableQueryMutation,
    DeleteGraphTableQueryMutationVariables
  >(DeleteGraphTableQueryDocument, options)
}
export type DeleteGraphTableQueryMutationHookResult = ReturnType<
  typeof useDeleteGraphTableQueryMutation
>
export type DeleteGraphTableQueryMutationResult =
  Apollo.MutationResult<DeleteGraphTableQueryMutation>
export type DeleteGraphTableQueryMutationOptions = Apollo.BaseMutationOptions<
  DeleteGraphTableQueryMutation,
  DeleteGraphTableQueryMutationVariables
>
export const CreateNodeTableQueryDocument = gql`
  ...
  ${NodeTableQueryFragmentDoc}
`
export type CreateNodeTableQueryMutationFn = Apollo.MutationFunction<
  CreateNodeTableQueryMutation,
 ...
 * });
 */
export function useCreateNodeTableQueryMutation(
  baseOptions?: ApolloReactHooks.MutationHookOptions<
    CreateNodeTableQueryMutation,
    CreateNodeTableQueryMutationVariables
  >
  ...
  return ApolloReactHooks.useMutation<
    CreateNodeTableQueryMutation,
    CreateNodeTableQueryMutationVariables
  >(CreateNodeTableQueryDocument, options)
}
export type CreateNodeTableQueryMutationHookResult = ReturnType<
  typeof useCreateNodeTableQueryMutation
>
export type CreateNodeTableQueryMutationResult = Apollo.MutationResult<CreateNodeTableQueryMutation>
export type CreateNodeTableQueryMutationOptions = Apollo.BaseMutationOptions<
  CreateNodeTableQueryMutation,
  CreateNodeTableQueryMutationVariables
>
export const UpdateNodeTableQueryDocument = gql`
  ...
  ${NodeTableQueryFragmentDoc}
`
export type UpdateNodeTableQueryMutationFn = Apollo.MutationFunction<
  UpdateNodeTableQueryMutation,
  UpdateNodeTableQueryMutationVariables
>
 ...
 * });
 */
export function useUpdateNodeTableQueryMutation(
  baseOptions?: ApolloReactHooks.MutationHookOptions<
    UpdateNodeTableQueryMutation,
    UpdateNodeTableQueryMutationVariables
  >
  ...
  return ApolloReactHooks.useMutation<
    UpdateNodeTableQueryMutation,
    UpdateNodeTableQueryMutationVariables
  >(UpdateNodeTableQueryDocument, options)
}
export type UpdateNodeTableQueryMutationHookResult = ReturnType<
  typeof useUpdateNodeTableQueryMutation
>
export type UpdateNodeTableQueryMutationResult = Apollo.MutationResult<UpdateNodeTableQueryMutation>
export type UpdateNodeTableQueryMutationOptions = Apollo.BaseMutationOptions<
  UpdateNodeTableQueryMutation,
  UpdateNodeTableQueryMutationVariables
>
...
`
export type CreateScatterPlotMutationFn = Apollo.MutationFunction<
  CreateScatterPlotMutation,
  CreateScatterPlotMutationVariables
>
 ...
 * });
 */
export function useCreateScatterPlotMutation(
  baseOptions?: ApolloReactHooks.MutationHookOptions<
    CreateScatterPlotMutation,
    CreateScatterPlotMutationVariables
  >
  ...
  return ApolloReactHooks.useMutation<
    CreateScatterPlotMutation,
    CreateScatterPlotMutationVariables
  >(CreateScatterPlotDocument, options)
}
...
export type CreateScatterPlotMutationOptions = Apollo.BaseMutationOptions<
  CreateScatterPlotMutation,
  CreateScatterPlotMutationVariables
>
...
`
export type DeleteScatterPlotMutationFn = Apollo.MutationFunction<
  DeleteScatterPlotMutation,
  DeleteScatterPlotMutationVariables
>
 ...
 * });
 */
export function useDeleteScatterPlotMutation(
  baseOptions?: ApolloReactHooks.MutationHookOptions<
    DeleteScatterPlotMutation,
    DeleteScatterPlotMutationVariables
  >
  ...
  return ApolloReactHooks.useMutation<
    DeleteScatterPlotMutation,
    DeleteScatterPlotMutationVariables
  >(DeleteScatterPlotDocument, options)
}
...
export type DeleteScatterPlotMutationOptions = Apollo.BaseMutationOptions<
  DeleteScatterPlotMutation,
  DeleteScatterPlotMutationVariables
>
...
export const ArchiveMetricDocument = gql`
  ...
  ${MetricFragmentDoc}
`
export type ArchiveMetricMutationFn = Apollo.MutationFunction<
  ArchiveMetricMutation,
  ArchiveMetricMutationVariables
>
 ...
 * });
 */
export function useArchiveMetricMutation(
  baseOptions?: ApolloReactHooks.MutationHookOptions<
    ArchiveMetricMutation,
    ArchiveMetricMutationVariables
  >
  ...
  const options = { ...defaultOptions, ...baseOptions }
  return ApolloReactHooks.useMutation<ArchiveMetricMutation, ArchiveMetricMutationVariables>(
    ArchiveMetricDocument,
    options
  )
}
...
export type ArchiveMetricMutationOptions = Apollo.BaseMutationOptions<
  ArchiveMetricMutation,
  ArchiveMetricMutationVariables
>
...
`
export type CreateNaturalEventMutationFn = Apollo.MutationFunction<
  CreateNaturalEventMutation,
  CreateNaturalEventMutationVariables
>
 ...
 * });
 */
export function useCreateNaturalEventMutation(
  baseOptions?: ApolloReactHooks.MutationHookOptions<
    CreateNaturalEventMutation,
    CreateNaturalEventMutationVariables
  >
  ...
  return ApolloReactHooks.useMutation<
    CreateNaturalEventMutation,
    CreateNaturalEventMutationVariables
  >(CreateNaturalEventDocument, options)
}
...
export type CreateNaturalEventMutationOptions = Apollo.BaseMutationOptions<
  CreateNaturalEventMutation,
  CreateNaturalEventMutationVariables
>
...
`
export type DeleteNaturalEventMutationFn = Apollo.MutationFunction<
  DeleteNaturalEventMutation,
  DeleteNaturalEventMutationVariables
>
 ...
 * });
 */
export function useDeleteNaturalEventMutation(
  baseOptions?: ApolloReactHooks.MutationHookOptions<
    DeleteNaturalEventMutation,
    DeleteNaturalEventMutationVariables
  >
  ...
  return ApolloReactHooks.useMutation<
    DeleteNaturalEventMutation,
    DeleteNaturalEventMutationVariables
  >(DeleteNaturalEventDocument, options)
}
...
export type DeleteNaturalEventMutationOptions = Apollo.BaseMutationOptions<
  DeleteNaturalEventMutation,
  DeleteNaturalEventMutationVariables
>
export const ArchiveNaturalEventDocument = gql`
  ...
  ${NaturalEventFragmentDoc}
`
export type ArchiveNaturalEventMutationFn = Apollo.MutationFunction<
  ArchiveNaturalEventMutation,
  ArchiveNaturalEventMutationVariables
>
 ...
 * });
 */
export function useArchiveNaturalEventMutation(
  baseOptions?: ApolloReactHooks.MutationHookOptions<
    ArchiveNaturalEventMutation,
    ArchiveNaturalEventMutationVariables
  >
  ...
  return ApolloReactHooks.useMutation<
    ArchiveNaturalEventMutation,
    ArchiveNaturalEventMutationVariables
  >(ArchiveNaturalEventDocument, options)
}
export type ArchiveNaturalEventMutationHookResult = ReturnType<
  typeof useArchiveNaturalEventMutation
>
export type ArchiveNaturalEventMutationResult = Apollo.MutationResult<ArchiveNaturalEventMutation>
export type ArchiveNaturalEventMutationOptions = Apollo.BaseMutationOptions<
  ArchiveNaturalEventMutation,
  ArchiveNaturalEventMutationVariables
>
export const UpdateNaturalEventDocument = gql`
  ...
  ${NaturalEventFragmentDoc}
`
export type UpdateNaturalEventMutationFn = Apollo.MutationFunction<
  UpdateNaturalEventMutation,
  UpdateNaturalEventMutationVariables
>
 ...
 * });
 */
export function useUpdateNaturalEventMutation(
  baseOptions?: ApolloReactHooks.MutationHookOptions<
    UpdateNaturalEventMutation,
    UpdateNaturalEventMutationVariables
  >
  ...
  return ApolloReactHooks.useMutation<
    UpdateNaturalEventMutation,
    UpdateNaturalEventMutationVariables
  >(UpdateNaturalEventDocument, options)
}
...
export type UpdateNaturalEventMutationOptions = Apollo.BaseMutationOptions<
  UpdateNaturalEventMutation,
  UpdateNaturalEventMutationVariables
>
...
`
export type CreateProtocolEventMutationFn = Apollo.MutationFunction<
  CreateProtocolEventMutation,
  CreateProtocolEventMutationVariables
>
 ...
 * });
 */
export function useCreateProtocolEventMutation(
  baseOptions?: ApolloReactHooks.MutationHookOptions<
    CreateProtocolEventMutation,
    CreateProtocolEventMutationVariables
  >
  ...
  return ApolloReactHooks.useMutation<
    CreateProtocolEventMutation,
    CreateProtocolEventMutationVariables
  >(CreateProtocolEventDocument, options)
}
export type CreateProtocolEventMutationHookResult = ReturnType<
  typeof useCreateProtocolEventMutation
>
export type CreateProtocolEventMutationResult = Apollo.MutationResult<CreateProtocolEventMutation>
export type CreateProtocolEventMutationOptions = Apollo.BaseMutationOptions<
  CreateProtocolEventMutation,
  CreateProtocolEventMutationVariables
>
...
`
export type DeleteProtocolEventMutationFn = Apollo.MutationFunction<
  DeleteProtocolEventMutation,
  DeleteProtocolEventMutationVariables
>
 ...
 * });
 */
export function useDeleteProtocolEventMutation(
  baseOptions?: ApolloReactHooks.MutationHookOptions<
    DeleteProtocolEventMutation,
    DeleteProtocolEventMutationVariables
  >
  ...
  return ApolloReactHooks.useMutation<
    DeleteProtocolEventMutation,
    DeleteProtocolEventMutationVariables
  >(DeleteProtocolEventDocument, options)
}
export type DeleteProtocolEventMutationHookResult = ReturnType<
  typeof useDeleteProtocolEventMutation
>
export type DeleteProtocolEventMutationResult = Apollo.MutationResult<DeleteProtocolEventMutation>
export type DeleteProtocolEventMutationOptions = Apollo.BaseMutationOptions<
  DeleteProtocolEventMutation,
  DeleteProtocolEventMutationVariables
>
export const ArchiveProtocolEventDocument = gql`
  ...
  ${ProtocolEventFragmentDoc}
`
export type ArchiveProtocolEventMutationFn = Apollo.MutationFunction<
  ArchiveProtocolEventMutation,
  ArchiveProtocolEventMutationVariables
>
 ...
 * });
 */
export function useArchiveProtocolEventMutation(
  baseOptions?: ApolloReactHooks.MutationHookOptions<
    ArchiveProtocolEventMutation,
    ArchiveProtocolEventMutationVariables
  >
  ...
  return ApolloReactHooks.useMutation<
    ArchiveProtocolEventMutation,
    ArchiveProtocolEventMutationVariables
  >(ArchiveProtocolEventDocument, options)
}
export type ArchiveProtocolEventMutationHookResult = ReturnType<
  typeof useArchiveProtocolEventMutation
>
export type ArchiveProtocolEventMutationResult = Apollo.MutationResult<ArchiveProtocolEventMutation>
export type ArchiveProtocolEventMutationOptions = Apollo.BaseMutationOptions<
  ArchiveProtocolEventMutation,
  ArchiveProtocolEventMutationVariables
>
export const UpdateProtocolEventDocument = gql`
  ...
  ${ProtocolEventFragmentDoc}
`
export type UpdateProtocolEventMutationFn = Apollo.MutationFunction<
  UpdateProtocolEventMutation,
  UpdateProtocolEventMutationVariables
>
 ...
 * });
 */
export function useUpdateProtocolEventMutation(
  baseOptions?: ApolloReactHooks.MutationHookOptions<
    UpdateProtocolEventMutation,
    UpdateProtocolEventMutationVariables
  >
  ...
  return ApolloReactHooks.useMutation<
    UpdateProtocolEventMutation,
    UpdateProtocolEventMutationVariables
  >(UpdateProtocolEventDocument, options)
}
export type UpdateProtocolEventMutationHookResult = ReturnType<
  typeof useUpdateProtocolEventMutation
>
export type UpdateProtocolEventMutationResult = Apollo.MutationResult<UpdateProtocolEventMutation>
export type UpdateProtocolEventMutationOptions = Apollo.BaseMutationOptions<
  UpdateProtocolEventMutation,
  UpdateProtocolEventMutationVariables
>
...
export function useCreateRelationMutation(
  ...
  const options = { ...defaultOptions, ...baseOptions }
  return ApolloReactHooks.useMutation<CreateRelationMutation, CreateRelationMutationVariables>(
...
export function useDeleteRelationMutation(
  ...
  const options = { ...defaultOptions, ...baseOptions }
  return ApolloReactHooks.useMutation<DeleteRelationMutation, DeleteRelationMutationVariables>(
...
export const ArchiveRelationDocument = gql`
  ...
  ${RelationFragmentDoc}
`
export type ArchiveRelationMutationFn = Apollo.MutationFunction<
  ArchiveRelationMutation,
  ArchiveRelationMutationVariables
>
 ...
 * });
 */
export function useArchiveRelationMutation(
  baseOptions?: ApolloReactHooks.MutationHookOptions<
    ArchiveRelationMutation,
    ArchiveRelationMutationVariables
  >
  ...
  const options = { ...defaultOptions, ...baseOptions }
  return ApolloReactHooks.useMutation<ArchiveRelationMutation, ArchiveRelationMutationVariables>(
    ArchiveRelationDocument,
    options
  )
}
...
export type ArchiveRelationMutationOptions = Apollo.BaseMutationOptions<
  ArchiveRelationMutation,
  ArchiveRelationMutationVariables
>
...
export function useUpdateRelationMutation(
  ...
  const options = { ...defaultOptions, ...baseOptions }
  return ApolloReactHooks.useMutation<UpdateRelationMutation, UpdateRelationMutationVariables>(
...
export const CreateEntityCategoryDocument = gql`
  ...
  ${EntityCategoryFragmentDoc}
`
export type CreateEntityCategoryMutationFn = Apollo.MutationFunction<
 ...
 * });
 */
export function useCreateEntityCategoryMutation(
  baseOptions?: ApolloReactHooks.MutationHookOptions<
    CreateEntityCategoryMutation,
    CreateEntityCategoryMutationVariables
  >
  ...
  return ApolloReactHooks.useMutation<
    CreateEntityCategoryMutation,
    CreateEntityCategoryMutationVariables
  >(CreateEntityCategoryDocument, options)
}
export type CreateEntityCategoryMutationHookResult = ReturnType<
  typeof useCreateEntityCategoryMutation
>
export type CreateEntityCategoryMutationResult = Apollo.MutationResult<CreateEntityCategoryMutation>
export type CreateEntityCategoryMutationOptions = Apollo.BaseMutationOptions<
  CreateEntityCategoryMutation,
  CreateEntityCategoryMutationVariables
>
export const UpdateEntityCategoryDocument = gql`
  ...
  ${EntityCategoryFragmentDoc}
`
export type UpdateEntityCategoryMutationFn = Apollo.MutationFunction<
 ...
 * });
 */
export function useUpdateEntityCategoryMutation(
  baseOptions?: ApolloReactHooks.MutationHookOptions<
    UpdateEntityCategoryMutation,
    UpdateEntityCategoryMutationVariables
  >
  ...
  return ApolloReactHooks.useMutation<
    UpdateEntityCategoryMutation,
    UpdateEntityCategoryMutationVariables
  >(UpdateEntityCategoryDocument, options)
}
export type UpdateEntityCategoryMutationHookResult = ReturnType<
  typeof useUpdateEntityCategoryMutation
>
export type UpdateEntityCategoryMutationResult = Apollo.MutationResult<UpdateEntityCategoryMutation>
export type UpdateEntityCategoryMutationOptions = Apollo.BaseMutationOptions<
  UpdateEntityCategoryMutation,
  UpdateEntityCategoryMutationVariables
>
...
`
export type DeleteEntityCategoryMutationFn = Apollo.MutationFunction<
  DeleteEntityCategoryMutation,
  DeleteEntityCategoryMutationVariables
>
 ...
 * });
 */
export function useDeleteEntityCategoryMutation(
  baseOptions?: ApolloReactHooks.MutationHookOptions<
    DeleteEntityCategoryMutation,
    DeleteEntityCategoryMutationVariables
  >
  ...
  return ApolloReactHooks.useMutation<
    DeleteEntityCategoryMutation,
    DeleteEntityCategoryMutationVariables
  >(DeleteEntityCategoryDocument, options)
}
export type DeleteEntityCategoryMutationHookResult = ReturnType<
  typeof useDeleteEntityCategoryMutation
>
export type DeleteEntityCategoryMutationResult = Apollo.MutationResult<DeleteEntityCategoryMutation>
export type DeleteEntityCategoryMutationOptions = Apollo.BaseMutationOptions<
  DeleteEntityCategoryMutation,
  DeleteEntityCategoryMutationVariables
>
...
export function useCreateGraphMutation(
  ...
  const options = { ...defaultOptions, ...baseOptions }
  return ApolloReactHooks.useMutation<CreateGraphMutation, CreateGraphMutationVariables>(
    CreateGraphDocument,
    options
  )
}
...
`
export type CreateInlineGraphMutationFn = Apollo.MutationFunction<
  CreateInlineGraphMutation,
  CreateInlineGraphMutationVariables
>
 ...
 * });
 */
export function useCreateInlineGraphMutation(
  baseOptions?: ApolloReactHooks.MutationHookOptions<
    CreateInlineGraphMutation,
    CreateInlineGraphMutationVariables
  >
  ...
  return ApolloReactHooks.useMutation<
    CreateInlineGraphMutation,
    CreateInlineGraphMutationVariables
  >(CreateInlineGraphDocument, options)
}
...
export type CreateInlineGraphMutationOptions = Apollo.BaseMutationOptions<
  CreateInlineGraphMutation,
  CreateInlineGraphMutationVariables
>
...
export function useDeleteGraphMutation(
  ...
  const options = { ...defaultOptions, ...baseOptions }
  return ApolloReactHooks.useMutation<DeleteGraphMutation, DeleteGraphMutationVariables>(
    DeleteGraphDocument,
    options
  )
}
...
export const ArchiveGraphDocument = gql`
  ...
  ${GraphFragmentDoc}
`
export type ArchiveGraphMutationFn = Apollo.MutationFunction<
  ArchiveGraphMutation,
  ArchiveGraphMutationVariables
>
...
export function useArchiveGraphMutation(
  ...
  const options = { ...defaultOptions, ...baseOptions }
  return ApolloReactHooks.useMutation<ArchiveGraphMutation, ArchiveGraphMutationVariables>(
    ArchiveGraphDocument,
    options
  )
}
...
export type ArchiveGraphMutationOptions = Apollo.BaseMutationOptions<
  ArchiveGraphMutation,
  ArchiveGraphMutationVariables
>
export const UpdateGraphDocument = gql`
  ...
  ${GraphFragmentDoc}
`
export type UpdateGraphMutationFn = Apollo.MutationFunction<
  UpdateGraphMutation,
  UpdateGraphMutationVariables
>
...
export function useUpdateGraphMutation(
  ...
  const options = { ...defaultOptions, ...baseOptions }
  return ApolloReactHooks.useMutation<UpdateGraphMutation, UpdateGraphMutationVariables>(
    UpdateGraphDocument,
    options
  )
}
...
export type UpdateGraphMutationOptions = Apollo.BaseMutationOptions<
  UpdateGraphMutation,
  UpdateGraphMutationVariables
>
...
`
export type CreateMeasurementCategoryMutationFn = Apollo.MutationFunction<
 ...
 * });
 */
export function useCreateMeasurementCategoryMutation(
  baseOptions?: ApolloReactHooks.MutationHookOptions<
    CreateMeasurementCategoryMutation,
    CreateMeasurementCategoryMutationVariables
  >
  ...
  return ApolloReactHooks.useMutation<
    CreateMeasurementCategoryMutation,
    CreateMeasurementCategoryMutationVariables
  >(CreateMeasurementCategoryDocument, options)
}
export type CreateMeasurementCategoryMutationHookResult = ReturnType<
  typeof useCreateMeasurementCategoryMutation
>
export type CreateMeasurementCategoryMutationResult =
  Apollo.MutationResult<CreateMeasurementCategoryMutation>
export type CreateMeasurementCategoryMutationOptions = Apollo.BaseMutationOptions<
  CreateMeasurementCategoryMutation,
  CreateMeasurementCategoryMutationVariables
>
export const UpdateMeasurementCategoryDocument = gql`
  ...
  ${MeasurementCategoryFragmentDoc}
`
export type UpdateMeasurementCategoryMutationFn = Apollo.MutationFunction<
 ...
 * });
 */
export function useUpdateMeasurementCategoryMutation(
  baseOptions?: ApolloReactHooks.MutationHookOptions<
    UpdateMeasurementCategoryMutation,
    UpdateMeasurementCategoryMutationVariables
  >
  ...
  return ApolloReactHooks.useMutation<
    UpdateMeasurementCategoryMutation,
    UpdateMeasurementCategoryMutationVariables
  >(UpdateMeasurementCategoryDocument, options)
}
export type UpdateMeasurementCategoryMutationHookResult = ReturnType<
  typeof useUpdateMeasurementCategoryMutation
>
export type UpdateMeasurementCategoryMutationResult =
  Apollo.MutationResult<UpdateMeasurementCategoryMutation>
export type UpdateMeasurementCategoryMutationOptions = Apollo.BaseMutationOptions<
  UpdateMeasurementCategoryMutation,
  UpdateMeasurementCategoryMutationVariables
>
...
`
export type DeleteMeasurementCategoryMutationFn = Apollo.MutationFunction<
  DeleteMeasurementCategoryMutation,
  DeleteMeasurementCategoryMutationVariables
>
 ...
 * });
 */
export function useDeleteMeasurementCategoryMutation(
  baseOptions?: ApolloReactHooks.MutationHookOptions<
    DeleteMeasurementCategoryMutation,
    DeleteMeasurementCategoryMutationVariables
  >
  ...
  return ApolloReactHooks.useMutation<
    DeleteMeasurementCategoryMutation,
    DeleteMeasurementCategoryMutationVariables
  >(DeleteMeasurementCategoryDocument, options)
}
export type DeleteMeasurementCategoryMutationHookResult = ReturnType<
  typeof useDeleteMeasurementCategoryMutation
>
export type DeleteMeasurementCategoryMutationResult =
  Apollo.MutationResult<DeleteMeasurementCategoryMutation>
export type DeleteMeasurementCategoryMutationOptions = Apollo.BaseMutationOptions<
  DeleteMeasurementCategoryMutation,
  DeleteMeasurementCategoryMutationVariables
>
export const CreateMetricCategoryDocument = gql`
  ...
  ${MetricCategoryFragmentDoc}
`
export type CreateMetricCategoryMutationFn = Apollo.MutationFunction<
 ...
 * });
 */
export function useCreateMetricCategoryMutation(
  baseOptions?: ApolloReactHooks.MutationHookOptions<
    CreateMetricCategoryMutation,
    CreateMetricCategoryMutationVariables
  >
  ...
  return ApolloReactHooks.useMutation<
    CreateMetricCategoryMutation,
    CreateMetricCategoryMutationVariables
  >(CreateMetricCategoryDocument, options)
}
export type CreateMetricCategoryMutationHookResult = ReturnType<
  typeof useCreateMetricCategoryMutation
>
export type CreateMetricCategoryMutationResult = Apollo.MutationResult<CreateMetricCategoryMutation>
export type CreateMetricCategoryMutationOptions = Apollo.BaseMutationOptions<
  CreateMetricCategoryMutation,
  CreateMetricCategoryMutationVariables
>
export const UpdateMetricCategoryDocument = gql`
  ...
  ${MetricCategoryFragmentDoc}
`
export type UpdateMetricCategoryMutationFn = Apollo.MutationFunction<
  UpdateMetricCategoryMutation,
 ...
 * });
 */
export function useUpdateMetricCategoryMutation(
  baseOptions?: ApolloReactHooks.MutationHookOptions<
    UpdateMetricCategoryMutation,
    UpdateMetricCategoryMutationVariables
  >
  ...
  return ApolloReactHooks.useMutation<
    UpdateMetricCategoryMutation,
    UpdateMetricCategoryMutationVariables
  >(UpdateMetricCategoryDocument, options)
}
export type UpdateMetricCategoryMutationHookResult = ReturnType<
  typeof useUpdateMetricCategoryMutation
>
export type UpdateMetricCategoryMutationResult = Apollo.MutationResult<UpdateMetricCategoryMutation>
export type UpdateMetricCategoryMutationOptions = Apollo.BaseMutationOptions<
  UpdateMetricCategoryMutation,
  UpdateMetricCategoryMutationVariables
>
...
`
export type DeleteMetricCategoryMutationFn = Apollo.MutationFunction<
  DeleteMetricCategoryMutation,
  DeleteMetricCategoryMutationVariables
>
 ...
 * });
 */
export function useDeleteMetricCategoryMutation(
  baseOptions?: ApolloReactHooks.MutationHookOptions<
    DeleteMetricCategoryMutation,
    DeleteMetricCategoryMutationVariables
  >
  ...
  return ApolloReactHooks.useMutation<
    DeleteMetricCategoryMutation,
    DeleteMetricCategoryMutationVariables
  >(DeleteMetricCategoryDocument, options)
}
export type DeleteMetricCategoryMutationHookResult = ReturnType<
  typeof useDeleteMetricCategoryMutation
>
export type DeleteMetricCategoryMutationResult = Apollo.MutationResult<DeleteMetricCategoryMutation>
export type DeleteMetricCategoryMutationOptions = Apollo.BaseMutationOptions<
  DeleteMetricCategoryMutation,
  DeleteMetricCategoryMutationVariables
>
export const CreateNaturalEventCategoryDocument = gql`
  ...
  ${NaturalEventCategoryFragmentDoc}
`
export type CreateNaturalEventCategoryMutationFn = Apollo.MutationFunction<
  CreateNaturalEventCategoryMutation,
  CreateNaturalEventCategoryMutationVariables
>
 ...
 * });
 */
export function useCreateNaturalEventCategoryMutation(
  baseOptions?: ApolloReactHooks.MutationHookOptions<
    CreateNaturalEventCategoryMutation,
    CreateNaturalEventCategoryMutationVariables
  >
  ...
  return ApolloReactHooks.useMutation<
    CreateNaturalEventCategoryMutation,
    CreateNaturalEventCategoryMutationVariables
  >(CreateNaturalEventCategoryDocument, options)
}
export type CreateNaturalEventCategoryMutationHookResult = ReturnType<
  typeof useCreateNaturalEventCategoryMutation
>
export type CreateNaturalEventCategoryMutationResult =
  Apollo.MutationResult<CreateNaturalEventCategoryMutation>
export type CreateNaturalEventCategoryMutationOptions = Apollo.BaseMutationOptions<
  CreateNaturalEventCategoryMutation,
  CreateNaturalEventCategoryMutationVariables
>
export const UpdateNaturalEventCategoryDocument = gql`
  ...
  ${NaturalEventCategoryFragmentDoc}
`
export type UpdateNaturalEventCategoryMutationFn = Apollo.MutationFunction<
 ...
 * });
 */
export function useUpdateNaturalEventCategoryMutation(
  baseOptions?: ApolloReactHooks.MutationHookOptions<
    UpdateNaturalEventCategoryMutation,
    UpdateNaturalEventCategoryMutationVariables
  >
  ...
  return ApolloReactHooks.useMutation<
    UpdateNaturalEventCategoryMutation,
    UpdateNaturalEventCategoryMutationVariables
  >(UpdateNaturalEventCategoryDocument, options)
}
export type UpdateNaturalEventCategoryMutationHookResult = ReturnType<
  typeof useUpdateNaturalEventCategoryMutation
>
export type UpdateNaturalEventCategoryMutationResult =
  Apollo.MutationResult<UpdateNaturalEventCategoryMutation>
export type UpdateNaturalEventCategoryMutationOptions = Apollo.BaseMutationOptions<
  UpdateNaturalEventCategoryMutation,
  UpdateNaturalEventCategoryMutationVariables
>
...
`
export type DeleteNaturalEventCategoryMutationFn = Apollo.MutationFunction<
  DeleteNaturalEventCategoryMutation,
  DeleteNaturalEventCategoryMutationVariables
>
 ...
 * });
 */
export function useDeleteNaturalEventCategoryMutation(
  baseOptions?: ApolloReactHooks.MutationHookOptions<
    DeleteNaturalEventCategoryMutation,
    DeleteNaturalEventCategoryMutationVariables
  >
  ...
  return ApolloReactHooks.useMutation<
    DeleteNaturalEventCategoryMutation,
    DeleteNaturalEventCategoryMutationVariables
  >(DeleteNaturalEventCategoryDocument, options)
}
export type DeleteNaturalEventCategoryMutationHookResult = ReturnType<
  typeof useDeleteNaturalEventCategoryMutation
>
export type DeleteNaturalEventCategoryMutationResult =
  Apollo.MutationResult<DeleteNaturalEventCategoryMutation>
export type DeleteNaturalEventCategoryMutationOptions = Apollo.BaseMutationOptions<
  DeleteNaturalEventCategoryMutation,
  DeleteNaturalEventCategoryMutationVariables
>
export const CreateProtocolEventCategoryDocument = gql`
  ...
  ${ProtocolEventCategoryFragmentDoc}
`
export type CreateProtocolEventCategoryMutationFn = Apollo.MutationFunction<
 ...
 * });
 */
export function useCreateProtocolEventCategoryMutation(
  baseOptions?: ApolloReactHooks.MutationHookOptions<
    CreateProtocolEventCategoryMutation,
    CreateProtocolEventCategoryMutationVariables
  >
  ...
  return ApolloReactHooks.useMutation<
    CreateProtocolEventCategoryMutation,
    CreateProtocolEventCategoryMutationVariables
  >(CreateProtocolEventCategoryDocument, options)
}
export type CreateProtocolEventCategoryMutationHookResult = ReturnType<
  typeof useCreateProtocolEventCategoryMutation
>
export type CreateProtocolEventCategoryMutationResult =
  Apollo.MutationResult<CreateProtocolEventCategoryMutation>
export type CreateProtocolEventCategoryMutationOptions = Apollo.BaseMutationOptions<
  CreateProtocolEventCategoryMutation,
  CreateProtocolEventCategoryMutationVariables
>
export const UpdateProtocolEventCategoryDocument = gql`
  ...
  ${ProtocolEventCategoryFragmentDoc}
`
export type UpdateProtocolEventCategoryMutationFn = Apollo.MutationFunction<
 ...
 * });
 */
export function useUpdateProtocolEventCategoryMutation(
  baseOptions?: ApolloReactHooks.MutationHookOptions<
    UpdateProtocolEventCategoryMutation,
    UpdateProtocolEventCategoryMutationVariables
  >
  ...
  return ApolloReactHooks.useMutation<
    UpdateProtocolEventCategoryMutation,
    UpdateProtocolEventCategoryMutationVariables
  >(UpdateProtocolEventCategoryDocument, options)
}
export type UpdateProtocolEventCategoryMutationHookResult = ReturnType<
  typeof useUpdateProtocolEventCategoryMutation
>
export type UpdateProtocolEventCategoryMutationResult =
  Apollo.MutationResult<UpdateProtocolEventCategoryMutation>
export type UpdateProtocolEventCategoryMutationOptions = Apollo.BaseMutationOptions<
  UpdateProtocolEventCategoryMutation,
  UpdateProtocolEventCategoryMutationVariables
>
...
`
export type DeleteProtocolEventCategoryMutationFn = Apollo.MutationFunction<
  DeleteProtocolEventCategoryMutation,
  DeleteProtocolEventCategoryMutationVariables
>
 ...
 * });
 */
export function useDeleteProtocolEventCategoryMutation(
  baseOptions?: ApolloReactHooks.MutationHookOptions<
    DeleteProtocolEventCategoryMutation,
    DeleteProtocolEventCategoryMutationVariables
  >
  ...
  return ApolloReactHooks.useMutation<
    DeleteProtocolEventCategoryMutation,
    DeleteProtocolEventCategoryMutationVariables
  >(DeleteProtocolEventCategoryDocument, options)
}
export type DeleteProtocolEventCategoryMutationHookResult = ReturnType<
  typeof useDeleteProtocolEventCategoryMutation
>
export type DeleteProtocolEventCategoryMutationResult =
  Apollo.MutationResult<DeleteProtocolEventCategoryMutation>
export type DeleteProtocolEventCategoryMutationOptions = Apollo.BaseMutationOptions<
  DeleteProtocolEventCategoryMutation,
  DeleteProtocolEventCategoryMutationVariables
>
...
`
export type CreateRelationCategoryMutationFn = Apollo.MutationFunction<
 ...
 * });
 */
export function useCreateRelationCategoryMutation(
  baseOptions?: ApolloReactHooks.MutationHookOptions<
    CreateRelationCategoryMutation,
    CreateRelationCategoryMutationVariables
  >
  ...
  return ApolloReactHooks.useMutation<
    CreateRelationCategoryMutation,
    CreateRelationCategoryMutationVariables
  >(CreateRelationCategoryDocument, options)
}
export type CreateRelationCategoryMutationHookResult = ReturnType<
  typeof useCreateRelationCategoryMutation
>
export type CreateRelationCategoryMutationResult =
  Apollo.MutationResult<CreateRelationCategoryMutation>
export type CreateRelationCategoryMutationOptions = Apollo.BaseMutationOptions<
  CreateRelationCategoryMutation,
  CreateRelationCategoryMutationVariables
>
export const UpdateRelationCategoryDocument = gql`
  ...
  ${RelationCategoryFragmentDoc}
`
export type UpdateRelationCategoryMutationFn = Apollo.MutationFunction<
  UpdateRelationCategoryMutation,
 ...
 * });
 */
export function useUpdateRelationCategoryMutation(
  baseOptions?: ApolloReactHooks.MutationHookOptions<
    UpdateRelationCategoryMutation,
    UpdateRelationCategoryMutationVariables
  >
  ...
  return ApolloReactHooks.useMutation<
    UpdateRelationCategoryMutation,
    UpdateRelationCategoryMutationVariables
  >(UpdateRelationCategoryDocument, options)
}
export type UpdateRelationCategoryMutationHookResult = ReturnType<
  typeof useUpdateRelationCategoryMutation
>
export type UpdateRelationCategoryMutationResult =
  Apollo.MutationResult<UpdateRelationCategoryMutation>
export type UpdateRelationCategoryMutationOptions = Apollo.BaseMutationOptions<
  UpdateRelationCategoryMutation,
  UpdateRelationCategoryMutationVariables
>
...
`
export type DeleteRelationCategoryMutationFn = Apollo.MutationFunction<
  DeleteRelationCategoryMutation,
  DeleteRelationCategoryMutationVariables
>
 ...
 * });
 */
export function useDeleteRelationCategoryMutation(
  baseOptions?: ApolloReactHooks.MutationHookOptions<
    DeleteRelationCategoryMutation,
    DeleteRelationCategoryMutationVariables
  >
  ...
  return ApolloReactHooks.useMutation<
    DeleteRelationCategoryMutation,
    DeleteRelationCategoryMutationVariables
  >(DeleteRelationCategoryDocument, options)
}
export type DeleteRelationCategoryMutationHookResult = ReturnType<
  typeof useDeleteRelationCategoryMutation
>
export type DeleteRelationCategoryMutationResult =
  Apollo.MutationResult<DeleteRelationCategoryMutation>
export type DeleteRelationCategoryMutationOptions = Apollo.BaseMutationOptions<
  DeleteRelationCategoryMutation,
  DeleteRelationCategoryMutationVariables
>
export const CreateStructureCategoryDocument = gql`
  ...
  ${StructureCategoryFragmentDoc}
`
export type CreateStructureCategoryMutationFn = Apollo.MutationFunction<
 ...
 * });
 */
export function useCreateStructureCategoryMutation(
  baseOptions?: ApolloReactHooks.MutationHookOptions<
    CreateStructureCategoryMutation,
    CreateStructureCategoryMutationVariables
  >
  ...
  return ApolloReactHooks.useMutation<
    CreateStructureCategoryMutation,
    CreateStructureCategoryMutationVariables
  >(CreateStructureCategoryDocument, options)
}
export type CreateStructureCategoryMutationHookResult = ReturnType<
  typeof useCreateStructureCategoryMutation
>
export type CreateStructureCategoryMutationResult =
  Apollo.MutationResult<CreateStructureCategoryMutation>
export type CreateStructureCategoryMutationOptions = Apollo.BaseMutationOptions<
  CreateStructureCategoryMutation,
  CreateStructureCategoryMutationVariables
>
export const UpdateStructureCategoryDocument = gql`
  ...
  ${StructureCategoryFragmentDoc}
`
export type UpdateStructureCategoryMutationFn = Apollo.MutationFunction<
 ...
 * });
 */
export function useUpdateStructureCategoryMutation(
  baseOptions?: ApolloReactHooks.MutationHookOptions<
    UpdateStructureCategoryMutation,
    UpdateStructureCategoryMutationVariables
  >
  ...
  return ApolloReactHooks.useMutation<
    UpdateStructureCategoryMutation,
    UpdateStructureCategoryMutationVariables
  >(UpdateStructureCategoryDocument, options)
}
export type UpdateStructureCategoryMutationHookResult = ReturnType<
  typeof useUpdateStructureCategoryMutation
>
export type UpdateStructureCategoryMutationResult =
  Apollo.MutationResult<UpdateStructureCategoryMutation>
export type UpdateStructureCategoryMutationOptions = Apollo.BaseMutationOptions<
  UpdateStructureCategoryMutation,
  UpdateStructureCategoryMutationVariables
>
...
`
export type DeleteStructureCategoryMutationFn = Apollo.MutationFunction<
  DeleteStructureCategoryMutation,
  DeleteStructureCategoryMutationVariables
>
 ...
 * });
 */
export function useDeleteStructureCategoryMutation(
  baseOptions?: ApolloReactHooks.MutationHookOptions<
    DeleteStructureCategoryMutation,
    DeleteStructureCategoryMutationVariables
  >
  ...
  return ApolloReactHooks.useMutation<
    DeleteStructureCategoryMutation,
    DeleteStructureCategoryMutationVariables
  >(DeleteStructureCategoryDocument, options)
}
export type DeleteStructureCategoryMutationHookResult = ReturnType<
  typeof useDeleteStructureCategoryMutation
>
export type DeleteStructureCategoryMutationResult =
  Apollo.MutationResult<DeleteStructureCategoryMutation>
export type DeleteStructureCategoryMutationOptions = Apollo.BaseMutationOptions<
  DeleteStructureCategoryMutation,
  DeleteStructureCategoryMutationVariables
>
...
`
export type CreateStructureRelationCategoryMutationFn = Apollo.MutationFunction<
 ...
 * });
 */
export function useCreateStructureRelationCategoryMutation(
  baseOptions?: ApolloReactHooks.MutationHookOptions<
    CreateStructureRelationCategoryMutation,
    CreateStructureRelationCategoryMutationVariables
  >
  ...
  return ApolloReactHooks.useMutation<
    CreateStructureRelationCategoryMutation,
    CreateStructureRelationCategoryMutationVariables
  >(CreateStructureRelationCategoryDocument, options)
}
export type CreateStructureRelationCategoryMutationHookResult = ReturnType<
  typeof useCreateStructureRelationCategoryMutation
>
export type CreateStructureRelationCategoryMutationResult =
  Apollo.MutationResult<CreateStructureRelationCategoryMutation>
export type CreateStructureRelationCategoryMutationOptions = Apollo.BaseMutationOptions<
  CreateStructureRelationCategoryMutation,
  CreateStructureRelationCategoryMutationVariables
>
export const UpdateStructureRelationCategoryDocument = gql`
  ...
  ${StructureRelationCategoryFragmentDoc}
`
export type UpdateStructureRelationCategoryMutationFn = Apollo.MutationFunction<
 ...
 * });
 */
export function useUpdateStructureRelationCategoryMutation(
  baseOptions?: ApolloReactHooks.MutationHookOptions<
    UpdateStructureRelationCategoryMutation,
    UpdateStructureRelationCategoryMutationVariables
  >
  ...
  return ApolloReactHooks.useMutation<
    UpdateStructureRelationCategoryMutation,
    UpdateStructureRelationCategoryMutationVariables
  >(UpdateStructureRelationCategoryDocument, options)
}
export type UpdateStructureRelationCategoryMutationHookResult = ReturnType<
  typeof useUpdateStructureRelationCategoryMutation
>
export type UpdateStructureRelationCategoryMutationResult =
  Apollo.MutationResult<UpdateStructureRelationCategoryMutation>
export type UpdateStructureRelationCategoryMutationOptions = Apollo.BaseMutationOptions<
  UpdateStructureRelationCategoryMutation,
  UpdateStructureRelationCategoryMutationVariables
>
...
`
export type DeleteStructureRelationCategoryMutationFn = Apollo.MutationFunction<
  DeleteStructureRelationCategoryMutation,
  DeleteStructureRelationCategoryMutationVariables
>
 ...
 * });
 */
export function useDeleteStructureRelationCategoryMutation(
  baseOptions?: ApolloReactHooks.MutationHookOptions<
    DeleteStructureRelationCategoryMutation,
    DeleteStructureRelationCategoryMutationVariables
  >
  ...
  return ApolloReactHooks.useMutation<
    DeleteStructureRelationCategoryMutation,
    DeleteStructureRelationCategoryMutationVariables
  >(DeleteStructureRelationCategoryDocument, options)
}
export type DeleteStructureRelationCategoryMutationHookResult = ReturnType<
  typeof useDeleteStructureRelationCategoryMutation
>
export type DeleteStructureRelationCategoryMutationResult =
  Apollo.MutationResult<DeleteStructureRelationCategoryMutation>
export type DeleteStructureRelationCategoryMutationOptions = Apollo.BaseMutationOptions<
  DeleteStructureRelationCategoryMutation,
  DeleteStructureRelationCategoryMutationVariables
>
export const CreateStructureDocument = gql`
  ...
  ${StructureFragmentDoc}
`
export type CreateStructureMutationFn = Apollo.MutationFunction<
...
export function useCreateStructureMutation(
  ...
  const options = { ...defaultOptions, ...baseOptions }
  return ApolloReactHooks.useMutation<CreateStructureMutation, CreateStructureMutationVariables>(
...
export type CreateStructureMutationOptions = Apollo.BaseMutationOptions<
  CreateStructureMutation,
  CreateStructureMutationVariables
>
export const EnsureStructureDocument = gql`
  ...
  ${StructureFragmentDoc}
`
export type EnsureStructureMutationFn = Apollo.MutationFunction<
  EnsureStructureMutation,
  EnsureStructureMutationVariables
>
 ...
 * });
 */
export function useEnsureStructureMutation(
  baseOptions?: ApolloReactHooks.MutationHookOptions<
    EnsureStructureMutation,
    EnsureStructureMutationVariables
  >
  ...
  const options = { ...defaultOptions, ...baseOptions }
  return ApolloReactHooks.useMutation<EnsureStructureMutation, EnsureStructureMutationVariables>(
...
export type EnsureStructureMutationOptions = Apollo.BaseMutationOptions<
  EnsureStructureMutation,
  EnsureStructureMutationVariables
>
...
`
export type DeleteStructureMutationFn = Apollo.MutationFunction<
...
export function useDeleteStructureMutation(
  ...
  const options = { ...defaultOptions, ...baseOptions }
  return ApolloReactHooks.useMutation<DeleteStructureMutation, DeleteStructureMutationVariables>(
    DeleteStructureDocument,
    options
  )
}
...
export type DeleteStructureMutationOptions = Apollo.BaseMutationOptions<
  DeleteStructureMutation,
  DeleteStructureMutationVariables
>
export const ArchiveStructureDocument = gql`
  ...
  ${StructureFragmentDoc}
`
export type ArchiveStructureMutationFn = Apollo.MutationFunction<
  ArchiveStructureMutation,
  ArchiveStructureMutationVariables
>
 ...
 * });
 */
export function useArchiveStructureMutation(
  baseOptions?: ApolloReactHooks.MutationHookOptions<
    ArchiveStructureMutation,
    ArchiveStructureMutationVariables
  >
  ...
  const options = { ...defaultOptions, ...baseOptions }
  return ApolloReactHooks.useMutation<ArchiveStructureMutation, ArchiveStructureMutationVariables>(
    ArchiveStructureDocument,
    options
  )
}
...
export type ArchiveStructureMutationOptions = Apollo.BaseMutationOptions<
  ArchiveStructureMutation,
  ArchiveStructureMutationVariables
>
export const UpdateStructureDocument = gql`
  ...
  ${StructureFragmentDoc}
`
export type UpdateStructureMutationFn = Apollo.MutationFunction<
...
export function useUpdateStructureMutation(
  ...
  const options = { ...defaultOptions, ...baseOptions }
  return ApolloReactHooks.useMutation<UpdateStructureMutation, UpdateStructureMutationVariables>(
...
export type UpdateStructureMutationOptions = Apollo.BaseMutationOptions<
  UpdateStructureMutation,
  UpdateStructureMutationVariables
>
export const CreateStructureRelationDocument = gql`
  ...
  ${StructureRelationFragmentDoc}
`
export type CreateStructureRelationMutationFn = Apollo.MutationFunction<
  CreateStructureRelationMutation,
  CreateStructureRelationMutationVariables
>
 ...
 * });
 */
export function useCreateStructureRelationMutation(
  baseOptions?: ApolloReactHooks.MutationHookOptions<
    CreateStructureRelationMutation,
    CreateStructureRelationMutationVariables
  >
  ...
  return ApolloReactHooks.useMutation<
    CreateStructureRelationMutation,
    CreateStructureRelationMutationVariables
  >(CreateStructureRelationDocument, options)
}
export type CreateStructureRelationMutationHookResult = ReturnType<
  typeof useCreateStructureRelationMutation
>
export type CreateStructureRelationMutationResult =
  Apollo.MutationResult<CreateStructureRelationMutation>
export type CreateStructureRelationMutationOptions = Apollo.BaseMutationOptions<
  CreateStructureRelationMutation,
  CreateStructureRelationMutationVariables
>
...
`
export type CreateGraphTagInlineMutationFn = Apollo.MutationFunction<
  CreateGraphTagInlineMutation,
  CreateGraphTagInlineMutationVariables
>
 ...
 * });
 */
export function useCreateGraphTagInlineMutation(
  baseOptions?: ApolloReactHooks.MutationHookOptions<
    CreateGraphTagInlineMutation,
    CreateGraphTagInlineMutationVariables
  >
  ...
  return ApolloReactHooks.useMutation<
    CreateGraphTagInlineMutation,
    CreateGraphTagInlineMutationVariables
  >(CreateGraphTagInlineDocument, options)
}
export type CreateGraphTagInlineMutationHookResult = ReturnType<
  typeof useCreateGraphTagInlineMutation
>
export type CreateGraphTagInlineMutationResult = Apollo.MutationResult<CreateGraphTagInlineMutation>
export type CreateGraphTagInlineMutationOptions = Apollo.BaseMutationOptions<
  CreateGraphTagInlineMutation,
  CreateGraphTagInlineMutationVariables
>
...
export function useGetEntityQuery(
  baseOptions: ApolloReactHooks.QueryHookOptions<GetEntityQuery, GetEntityQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions }
  return ApolloReactHooks.useQuery<GetEntityQuery, GetEntityQueryVariables>(
    GetEntityDocument,
    options
  )
}
export function useGetEntityLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<GetEntityQuery, GetEntityQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions }
  return ApolloReactHooks.useLazyQuery<GetEntityQuery, GetEntityQueryVariables>(
    GetEntityDocument,
    options
  )
}
...
export function useSearchEntitiesQuery(
  baseOptions: ApolloReactHooks.QueryHookOptions<SearchEntitiesQuery, SearchEntitiesQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions }
  return ApolloReactHooks.useQuery<SearchEntitiesQuery, SearchEntitiesQueryVariables>(
...
export function useSearchEntitiesLazyQuery(
  ...
  const options = { ...defaultOptions, ...baseOptions }
  return ApolloReactHooks.useLazyQuery<SearchEntitiesQuery, SearchEntitiesQueryVariables>(
    SearchEntitiesDocument,
    options
  )
}
...
export function useListEntitiesQuery(
  baseOptions: ApolloReactHooks.QueryHookOptions<ListEntitiesQuery, ListEntitiesQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions }
  return ApolloReactHooks.useQuery<ListEntitiesQuery, ListEntitiesQueryVariables>(
    ListEntitiesDocument,
    options
  )
}
export function useListEntitiesLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<ListEntitiesQuery, ListEntitiesQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions }
  return ApolloReactHooks.useLazyQuery<ListEntitiesQuery, ListEntitiesQueryVariables>(
    ListEntitiesDocument,
    options
  )
}
...
export type ListEntitiesQueryResult = Apollo.QueryResult<
  ListEntitiesQuery,
...
export function useGetGraphQuery(
  baseOptions: ApolloReactHooks.QueryHookOptions<GetGraphQuery, GetGraphQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions }
...
export function useGetGraphLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<GetGraphQuery, GetGraphQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions }
  return ApolloReactHooks.useLazyQuery<GetGraphQuery, GetGraphQueryVariables>(
    GetGraphDocument,
    options
  )
}
...
export const SearchGraphsDocument = gql`
  query SearchGraphs($search: String, $values: [ID!]) {
    options: graphs(filters: { search: $search, ids: $values }, pagination: { limit: 10 }) {
      value: id
      label: name
    }
  }
 ...
 * });
 */
export function useSearchGraphsQuery(
  baseOptions?: ApolloReactHooks.QueryHookOptions<SearchGraphsQuery, SearchGraphsQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions }
  return ApolloReactHooks.useQuery<SearchGraphsQuery, SearchGraphsQueryVariables>(
    SearchGraphsDocument,
    options
  )
}
export function useSearchGraphsLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<SearchGraphsQuery, SearchGraphsQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions }
  return ApolloReactHooks.useLazyQuery<SearchGraphsQuery, SearchGraphsQueryVariables>(
    SearchGraphsDocument,
    options
  )
}
...
export type SearchGraphsQueryResult = Apollo.QueryResult<
  SearchGraphsQuery,
  SearchGraphsQueryVariables
>
 ...
 * });
 */
export function useListGraphsQuery(
  baseOptions?: ApolloReactHooks.QueryHookOptions<ListGraphsQuery, ListGraphsQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions }
  return ApolloReactHooks.useQuery<ListGraphsQuery, ListGraphsQueryVariables>(
    ListGraphsDocument,
    options
  )
}
export function useListGraphsLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<ListGraphsQuery, ListGraphsQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions }
  return ApolloReactHooks.useLazyQuery<ListGraphsQuery, ListGraphsQueryVariables>(
    ListGraphsDocument,
    options
  )
}
 ...
 * });
 */
export function useGetGraphTableQueryQuery(
  baseOptions: ApolloReactHooks.QueryHookOptions<
    GetGraphTableQueryQuery,
    GetGraphTableQueryQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions }
  return ApolloReactHooks.useQuery<GetGraphTableQueryQuery, GetGraphTableQueryQueryVariables>(
    GetGraphTableQueryDocument,
    options
  )
}
export function useGetGraphTableQueryLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
    GetGraphTableQueryQuery,
    GetGraphTableQueryQueryVariables
  >
  ...
  const options = { ...defaultOptions, ...baseOptions }
  return ApolloReactHooks.useLazyQuery<GetGraphTableQueryQuery, GetGraphTableQueryQueryVariables>(
    GetGraphTableQueryDocument,
    options
  )
}
export type GetGraphTableQueryQueryHookResult = ReturnType<typeof useGetGraphTableQueryQuery>
export type GetGraphTableQueryLazyQueryHookResult = ReturnType<
  typeof useGetGraphTableQueryLazyQuery
>
export type GetGraphTableQueryQueryResult = Apollo.QueryResult<
  GetGraphTableQueryQuery,
  GetGraphTableQueryQueryVariables
>
 ...
 * });
 */
export function useSearchGraphTableQueriesQuery(
  baseOptions?: ApolloReactHooks.QueryHookOptions<
    SearchGraphTableQueriesQuery,
    SearchGraphTableQueriesQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions }
  return ApolloReactHooks.useQuery<
    SearchGraphTableQueriesQuery,
    SearchGraphTableQueriesQueryVariables
  >(SearchGraphTableQueriesDocument, options)
}
export function useSearchGraphTableQueriesLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
    SearchGraphTableQueriesQuery,
    SearchGraphTableQueriesQueryVariables
  >
...
export type SearchGraphTableQueriesQueryHookResult = ReturnType<
  typeof useSearchGraphTableQueriesQuery
>
export type SearchGraphTableQueriesLazyQueryHookResult = ReturnType<
  typeof useSearchGraphTableQueriesLazyQuery
>
export type SearchGraphTableQueriesQueryResult = Apollo.QueryResult<
  SearchGraphTableQueriesQuery,
  SearchGraphTableQueriesQueryVariables
>
 ...
 * });
 */
export function useListGraphTableQueriesQuery(
  baseOptions?: ApolloReactHooks.QueryHookOptions<
    ListGraphTableQueriesQuery,
    ListGraphTableQueriesQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions }
  return ApolloReactHooks.useQuery<ListGraphTableQueriesQuery, ListGraphTableQueriesQueryVariables>(
    ListGraphTableQueriesDocument,
    options
  )
}
export function useListGraphTableQueriesLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
    ListGraphTableQueriesQuery,
    ListGraphTableQueriesQueryVariables
  >
  ...
  return ApolloReactHooks.useLazyQuery<
    ListGraphTableQueriesQuery,
    ListGraphTableQueriesQueryVariables
  >(ListGraphTableQueriesDocument, options)
}
export type ListGraphTableQueriesQueryHookResult = ReturnType<typeof useListGraphTableQueriesQuery>
export type ListGraphTableQueriesLazyQueryHookResult = ReturnType<
  typeof useListGraphTableQueriesLazyQuery
>
export type ListGraphTableQueriesQueryResult = Apollo.QueryResult<
  ListGraphTableQueriesQuery,
  ListGraphTableQueriesQueryVariables
>
export const RenderGraphPathDocument = gql`
  query RenderGraphPath(
    $id: ID!
    $filters: RenderGraphPathFilter
    $pagination: RenderGraphPathPagination
    $order: RenderGraphPathOrder
  ) {
    renderGraphPath(query: $id, filters: $filters, pagination: $pagination, order: $order) {
      ...GraphPathRender
    }
  }
 ...
 * });
 */
export function useRenderGraphPathQuery(
  baseOptions: ApolloReactHooks.QueryHookOptions<
    RenderGraphPathQuery,
    RenderGraphPathQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions }
  return ApolloReactHooks.useQuery<RenderGraphPathQuery, RenderGraphPathQueryVariables>(
    RenderGraphPathDocument,
    options
  )
}
export function useRenderGraphPathLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
    RenderGraphPathQuery,
    RenderGraphPathQueryVariables
  >
  ...
  const options = { ...defaultOptions, ...baseOptions }
  return ApolloReactHooks.useLazyQuery<RenderGraphPathQuery, RenderGraphPathQueryVariables>(
    RenderGraphPathDocument,
    options
  )
}
...
export type RenderGraphPathQueryResult = Apollo.QueryResult<
  RenderGraphPathQuery,
  RenderGraphPathQueryVariables
>
export const RenderGraphTableDocument = gql`
  query RenderGraphTable(
    ...
    renderGraphTable(query: $id, filters: $filters, pagination: $pagination, order: $order) {
      ...GraphTableRender
    }
  }
 ...
 * });
 */
export function useRenderGraphTableQuery(
  baseOptions: ApolloReactHooks.QueryHookOptions<
    RenderGraphTableQuery,
    RenderGraphTableQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions }
  return ApolloReactHooks.useQuery<RenderGraphTableQuery, RenderGraphTableQueryVariables>(
    RenderGraphTableDocument,
    options
  )
}
export function useRenderGraphTableLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
    RenderGraphTableQuery,
    RenderGraphTableQueryVariables
  >
  ...
  const options = { ...defaultOptions, ...baseOptions }
  return ApolloReactHooks.useLazyQuery<RenderGraphTableQuery, RenderGraphTableQueryVariables>(
    RenderGraphTableDocument,
    options
  )
}
...
export type RenderGraphTableQueryResult = Apollo.QueryResult<
  RenderGraphTableQuery,
  RenderGraphTableQueryVariables
>
 ...
 * });
 */
export function useGetScatterPlotQuery(
  baseOptions: ApolloReactHooks.QueryHookOptions<GetScatterPlotQuery, GetScatterPlotQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions }
  return ApolloReactHooks.useQuery<GetScatterPlotQuery, GetScatterPlotQueryVariables>(
    GetScatterPlotDocument,
    options
  )
}
export function useGetScatterPlotLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
    GetScatterPlotQuery,
    GetScatterPlotQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions }
  return ApolloReactHooks.useLazyQuery<GetScatterPlotQuery, GetScatterPlotQueryVariables>(
    GetScatterPlotDocument,
    options
  )
}
...
export type GetScatterPlotQueryResult = Apollo.QueryResult<
  GetScatterPlotQuery,
  GetScatterPlotQueryVariables
>
export const SearchScatterPlotsDocument = gql`
  query SearchScatterPlots($search: String, $values: [ID!]) {
    options: scatterPlots(filters: { search: $search, ids: $values }, pagination: { limit: 10 }) {
      value: id
      label: label
    }
  }
 ...
 * });
 */
export function useSearchScatterPlotsQuery(
  baseOptions?: ApolloReactHooks.QueryHookOptions<
    SearchScatterPlotsQuery,
    SearchScatterPlotsQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions }
  return ApolloReactHooks.useQuery<SearchScatterPlotsQuery, SearchScatterPlotsQueryVariables>(
    SearchScatterPlotsDocument,
    options
  )
}
export function useSearchScatterPlotsLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
    SearchScatterPlotsQuery,
    SearchScatterPlotsQueryVariables
  >
  ...
  const options = { ...defaultOptions, ...baseOptions }
  return ApolloReactHooks.useLazyQuery<SearchScatterPlotsQuery, SearchScatterPlotsQueryVariables>(
    SearchScatterPlotsDocument,
    options
  )
}
export type SearchScatterPlotsQueryHookResult = ReturnType<typeof useSearchScatterPlotsQuery>
export type SearchScatterPlotsLazyQueryHookResult = ReturnType<
  typeof useSearchScatterPlotsLazyQuery
>
export type SearchScatterPlotsQueryResult = Apollo.QueryResult<
  SearchScatterPlotsQuery,
  SearchScatterPlotsQueryVariables
>
 ...
 * });
 */
export function useListScatterPlotsQuery(
  baseOptions?: ApolloReactHooks.QueryHookOptions<
    ListScatterPlotsQuery,
    ListScatterPlotsQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions }
  return ApolloReactHooks.useQuery<ListScatterPlotsQuery, ListScatterPlotsQueryVariables>(
    ListScatterPlotsDocument,
    options
  )
}
export function useListScatterPlotsLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
    ListScatterPlotsQuery,
    ListScatterPlotsQueryVariables
  >
  ...
  const options = { ...defaultOptions, ...baseOptions }
  return ApolloReactHooks.useLazyQuery<ListScatterPlotsQuery, ListScatterPlotsQueryVariables>(
    ListScatterPlotsDocument,
    options
  )
}
...
export type ListScatterPlotsQueryResult = Apollo.QueryResult<
  ListScatterPlotsQuery,
  ListScatterPlotsQueryVariables
>
export const ListMaterializedEdgesDocument = gql`
  query ListMaterializedEdges(
    $filters: MaterializedEdgeFilter
    $pagination: OffsetPaginationInput
    $ordering: [MaterializedEdgeOrder!]
  ) {
    materializedEdges(filters: $filters, pagination: $pagination, ordering: $ordering) {
      ...ListMaterializedEdge
    }
  }
  ${ListMaterializedEdgeFragmentDoc}
 ...
 * });
 */
export function useListMaterializedEdgesQuery(
  baseOptions?: ApolloReactHooks.QueryHookOptions<
    ListMaterializedEdgesQuery,
    ListMaterializedEdgesQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions }
  return ApolloReactHooks.useQuery<ListMaterializedEdgesQuery, ListMaterializedEdgesQueryVariables>(
    ListMaterializedEdgesDocument,
    options
  )
}
export function useListMaterializedEdgesLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
    ListMaterializedEdgesQuery,
    ListMaterializedEdgesQueryVariables
  >
  ...
  return ApolloReactHooks.useLazyQuery<
    ListMaterializedEdgesQuery,
    ListMaterializedEdgesQueryVariables
  >(ListMaterializedEdgesDocument, options)
}
export type ListMaterializedEdgesQueryHookResult = ReturnType<typeof useListMaterializedEdgesQuery>
export type ListMaterializedEdgesLazyQueryHookResult = ReturnType<
  typeof useListMaterializedEdgesLazyQuery
>
export type ListMaterializedEdgesQueryResult = Apollo.QueryResult<
  ListMaterializedEdgesQuery,
  ListMaterializedEdgesQueryVariables
>
 ...
 * });
 */
export function useGetMaterializedEdgeQuery(
  baseOptions: ApolloReactHooks.QueryHookOptions<
    GetMaterializedEdgeQuery,
    GetMaterializedEdgeQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions }
  return ApolloReactHooks.useQuery<GetMaterializedEdgeQuery, GetMaterializedEdgeQueryVariables>(
    GetMaterializedEdgeDocument,
    options
  )
}
export function useGetMaterializedEdgeLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
    GetMaterializedEdgeQuery,
    GetMaterializedEdgeQueryVariables
  >
  ...
  const options = { ...defaultOptions, ...baseOptions }
  return ApolloReactHooks.useLazyQuery<GetMaterializedEdgeQuery, GetMaterializedEdgeQueryVariables>(
    GetMaterializedEdgeDocument,
    options
  )
}
export type GetMaterializedEdgeQueryHookResult = ReturnType<typeof useGetMaterializedEdgeQuery>
export type GetMaterializedEdgeLazyQueryHookResult = ReturnType<
  typeof useGetMaterializedEdgeLazyQuery
>
export type GetMaterializedEdgeQueryResult = Apollo.QueryResult<
  GetMaterializedEdgeQuery,
  GetMaterializedEdgeQueryVariables
>
 ...
 * });
 */
export function useGetMeasurementQuery(
  baseOptions: ApolloReactHooks.QueryHookOptions<GetMeasurementQuery, GetMeasurementQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions }
  return ApolloReactHooks.useQuery<GetMeasurementQuery, GetMeasurementQueryVariables>(
    GetMeasurementDocument,
    options
  )
}
export function useGetMeasurementLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
    GetMeasurementQuery,
    GetMeasurementQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions }
  return ApolloReactHooks.useLazyQuery<GetMeasurementQuery, GetMeasurementQueryVariables>(
    GetMeasurementDocument,
    options
  )
}
...
export type GetMeasurementQueryResult = Apollo.QueryResult<
  GetMeasurementQuery,
  GetMeasurementQueryVariables
>
 ...
 * });
 */
export function useSearchMeasurementsQuery(
  baseOptions: ApolloReactHooks.QueryHookOptions<
    SearchMeasurementsQuery,
    SearchMeasurementsQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions }
  return ApolloReactHooks.useQuery<SearchMeasurementsQuery, SearchMeasurementsQueryVariables>(
    SearchMeasurementsDocument,
    options
  )
}
export function useSearchMeasurementsLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
    SearchMeasurementsQuery,
    SearchMeasurementsQueryVariables
  >
  ...
  const options = { ...defaultOptions, ...baseOptions }
  return ApolloReactHooks.useLazyQuery<SearchMeasurementsQuery, SearchMeasurementsQueryVariables>(
    SearchMeasurementsDocument,
    options
  )
}
export type SearchMeasurementsQueryHookResult = ReturnType<typeof useSearchMeasurementsQuery>
export type SearchMeasurementsLazyQueryHookResult = ReturnType<
  typeof useSearchMeasurementsLazyQuery
>
export type SearchMeasurementsQueryResult = Apollo.QueryResult<
  SearchMeasurementsQuery,
  SearchMeasurementsQueryVariables
>
...
export function useGetMetricQuery(
  baseOptions: ApolloReactHooks.QueryHookOptions<GetMetricQuery, GetMetricQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions }
  return ApolloReactHooks.useQuery<GetMetricQuery, GetMetricQueryVariables>(
    GetMetricDocument,
    options
  )
}
export function useGetMetricLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<GetMetricQuery, GetMetricQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions }
  return ApolloReactHooks.useLazyQuery<GetMetricQuery, GetMetricQueryVariables>(
    GetMetricDocument,
    options
  )
}
 ...
 * });
 */
export function useSearchMetricsQuery(
  baseOptions: ApolloReactHooks.QueryHookOptions<SearchMetricsQuery, SearchMetricsQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions }
  return ApolloReactHooks.useQuery<SearchMetricsQuery, SearchMetricsQueryVariables>(
    SearchMetricsDocument,
    options
  )
}
export function useSearchMetricsLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
    SearchMetricsQuery,
    SearchMetricsQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions }
  return ApolloReactHooks.useLazyQuery<SearchMetricsQuery, SearchMetricsQueryVariables>(
    SearchMetricsDocument,
    options
  )
}
...
export type SearchMetricsQueryResult = Apollo.QueryResult<
  SearchMetricsQuery,
  SearchMetricsQueryVariables
>
export const ListMetricsDocument = gql`
  query ListMetrics(
    ...
    $pagination: MetricPaginationInput
    $ordering: [MetricOrder!]
  ) {
    metrics(
      metricCategoryId: $category
      filters: $filters
 ...
 * });
 */
export function useListMetricsQuery(
  baseOptions: ApolloReactHooks.QueryHookOptions<ListMetricsQuery, ListMetricsQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions }
  return ApolloReactHooks.useQuery<ListMetricsQuery, ListMetricsQueryVariables>(
    ListMetricsDocument,
    options
  )
}
export function useListMetricsLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<ListMetricsQuery, ListMetricsQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions }
  return ApolloReactHooks.useLazyQuery<ListMetricsQuery, ListMetricsQueryVariables>(
    ListMetricsDocument,
    options
  )
}
 ...
 * });
 */
export function useGetNaturalEventQuery(
  baseOptions: ApolloReactHooks.QueryHookOptions<
    GetNaturalEventQuery,
    GetNaturalEventQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions }
  return ApolloReactHooks.useQuery<GetNaturalEventQuery, GetNaturalEventQueryVariables>(
    GetNaturalEventDocument,
    options
  )
}
export function useGetNaturalEventLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
    GetNaturalEventQuery,
    GetNaturalEventQueryVariables
  >
  ...
  const options = { ...defaultOptions, ...baseOptions }
  return ApolloReactHooks.useLazyQuery<GetNaturalEventQuery, GetNaturalEventQueryVariables>(
    GetNaturalEventDocument,
    options
  )
}
...
export type GetNaturalEventQueryResult = Apollo.QueryResult<
  GetNaturalEventQuery,
  GetNaturalEventQueryVariables
>
 ...
 * });
 */
export function useSearchNaturalEventsQuery(
  baseOptions: ApolloReactHooks.QueryHookOptions<
    SearchNaturalEventsQuery,
    SearchNaturalEventsQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions }
  return ApolloReactHooks.useQuery<SearchNaturalEventsQuery, SearchNaturalEventsQueryVariables>(
    SearchNaturalEventsDocument,
    options
  )
}
export function useSearchNaturalEventsLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
    SearchNaturalEventsQuery,
    SearchNaturalEventsQueryVariables
  >
  ...
  const options = { ...defaultOptions, ...baseOptions }
  return ApolloReactHooks.useLazyQuery<SearchNaturalEventsQuery, SearchNaturalEventsQueryVariables>(
    SearchNaturalEventsDocument,
    options
  )
}
export type SearchNaturalEventsQueryHookResult = ReturnType<typeof useSearchNaturalEventsQuery>
export type SearchNaturalEventsLazyQueryHookResult = ReturnType<
  typeof useSearchNaturalEventsLazyQuery
>
export type SearchNaturalEventsQueryResult = Apollo.QueryResult<
  SearchNaturalEventsQuery,
  SearchNaturalEventsQueryVariables
>
...
export function useGetNodeQuery(
  baseOptions: ApolloReactHooks.QueryHookOptions<GetNodeQuery, GetNodeQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions }
...
export function useGetNodeLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<GetNodeQuery, GetNodeQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions }
...
export const SearchNodesDocument = gql`
  query SearchNodes($graph: ID!, $search: String, $values: [GraphID!]) {
    options: nodes(
      graph: $graph
      filters: { search: $search, ids: $values }
      pagination: { limit: 10 }
 ...
 * });
 */
export function useSearchNodesQuery(
  baseOptions: ApolloReactHooks.QueryHookOptions<SearchNodesQuery, SearchNodesQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions }
  return ApolloReactHooks.useQuery<SearchNodesQuery, SearchNodesQueryVariables>(
    SearchNodesDocument,
    options
  )
}
export function useSearchNodesLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<SearchNodesQuery, SearchNodesQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions }
  return ApolloReactHooks.useLazyQuery<SearchNodesQuery, SearchNodesQueryVariables>(
    SearchNodesDocument,
    options
  )
}
 ...
 * });
 */
export function useListNodesQuery(
  baseOptions: ApolloReactHooks.QueryHookOptions<ListNodesQuery, ListNodesQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions }
  return ApolloReactHooks.useQuery<ListNodesQuery, ListNodesQueryVariables>(
    ListNodesDocument,
    options
  )
}
export function useListNodesLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<ListNodesQuery, ListNodesQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions }
  return ApolloReactHooks.useLazyQuery<ListNodesQuery, ListNodesQueryVariables>(
    ListNodesDocument,
    options
  )
}
 ...
 * });
 */
export function useGetProtocolEventQuery(
  baseOptions: ApolloReactHooks.QueryHookOptions<
    GetProtocolEventQuery,
    GetProtocolEventQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions }
  return ApolloReactHooks.useQuery<GetProtocolEventQuery, GetProtocolEventQueryVariables>(
    GetProtocolEventDocument,
    options
  )
}
export function useGetProtocolEventLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
    GetProtocolEventQuery,
    GetProtocolEventQueryVariables
  >
  ...
  const options = { ...defaultOptions, ...baseOptions }
  return ApolloReactHooks.useLazyQuery<GetProtocolEventQuery, GetProtocolEventQueryVariables>(
    GetProtocolEventDocument,
    options
  )
}
...
export type GetProtocolEventQueryResult = Apollo.QueryResult<
  GetProtocolEventQuery,
  GetProtocolEventQueryVariables
>
 ...
 * });
 */
export function useSearchProtocolEventsQuery(
  baseOptions: ApolloReactHooks.QueryHookOptions<
    SearchProtocolEventsQuery,
    SearchProtocolEventsQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions }
  return ApolloReactHooks.useQuery<SearchProtocolEventsQuery, SearchProtocolEventsQueryVariables>(
    SearchProtocolEventsDocument,
    options
  )
}
export function useSearchProtocolEventsLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
    SearchProtocolEventsQuery,
    SearchProtocolEventsQueryVariables
  >
  ...
  return ApolloReactHooks.useLazyQuery<
    SearchProtocolEventsQuery,
    SearchProtocolEventsQueryVariables
  >(SearchProtocolEventsDocument, options)
}
export type SearchProtocolEventsQueryHookResult = ReturnType<typeof useSearchProtocolEventsQuery>
export type SearchProtocolEventsLazyQueryHookResult = ReturnType<
  typeof useSearchProtocolEventsLazyQuery
>
export type SearchProtocolEventsQueryResult = Apollo.QueryResult<
  SearchProtocolEventsQuery,
  SearchProtocolEventsQueryVariables
>
...
export function useGetRelationQuery(
  baseOptions: ApolloReactHooks.QueryHookOptions<GetRelationQuery, GetRelationQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions }
  return ApolloReactHooks.useQuery<GetRelationQuery, GetRelationQueryVariables>(
    GetRelationDocument,
    options
  )
}
export function useGetRelationLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<GetRelationQuery, GetRelationQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions }
  return ApolloReactHooks.useLazyQuery<GetRelationQuery, GetRelationQueryVariables>(
    GetRelationDocument,
    options
  )
}
 ...
 * });
 */
export function useSearchRelationsQuery(
  baseOptions: ApolloReactHooks.QueryHookOptions<
    SearchRelationsQuery,
    SearchRelationsQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions }
  return ApolloReactHooks.useQuery<SearchRelationsQuery, SearchRelationsQueryVariables>(
    SearchRelationsDocument,
    options
  )
}
export function useSearchRelationsLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
    SearchRelationsQuery,
    SearchRelationsQueryVariables
  >
  ...
  const options = { ...defaultOptions, ...baseOptions }
  return ApolloReactHooks.useLazyQuery<SearchRelationsQuery, SearchRelationsQueryVariables>(
    SearchRelationsDocument,
    options
  )
}
...
export type SearchRelationsQueryResult = Apollo.QueryResult<
  SearchRelationsQuery,
  SearchRelationsQueryVariables
>
 ...
 * });
 */
export function useGetEntityCategoryQuery(
  baseOptions: ApolloReactHooks.QueryHookOptions<
    GetEntityCategoryQuery,
    GetEntityCategoryQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions }
  return ApolloReactHooks.useQuery<GetEntityCategoryQuery, GetEntityCategoryQueryVariables>(
    GetEntityCategoryDocument,
    options
  )
}
export function useGetEntityCategoryLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
    GetEntityCategoryQuery,
    GetEntityCategoryQueryVariables
  >
  ...
  const options = { ...defaultOptions, ...baseOptions }
  return ApolloReactHooks.useLazyQuery<GetEntityCategoryQuery, GetEntityCategoryQueryVariables>(
    GetEntityCategoryDocument,
    options
  )
}
...
export type GetEntityCategoryQueryResult = Apollo.QueryResult<
  GetEntityCategoryQuery,
  GetEntityCategoryQueryVariables
>
 ...
 * });
 */
export function useSearchEntityCategoryQuery(
  baseOptions?: ApolloReactHooks.QueryHookOptions<
    SearchEntityCategoryQuery,
    SearchEntityCategoryQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions }
  return ApolloReactHooks.useQuery<SearchEntityCategoryQuery, SearchEntityCategoryQueryVariables>(
    SearchEntityCategoryDocument,
    options
  )
}
export function useSearchEntityCategoryLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
    SearchEntityCategoryQuery,
    SearchEntityCategoryQueryVariables
  >
  ...
  return ApolloReactHooks.useLazyQuery<
    SearchEntityCategoryQuery,
    SearchEntityCategoryQueryVariables
  >(SearchEntityCategoryDocument, options)
}
export type SearchEntityCategoryQueryHookResult = ReturnType<typeof useSearchEntityCategoryQuery>
export type SearchEntityCategoryLazyQueryHookResult = ReturnType<
  typeof useSearchEntityCategoryLazyQuery
>
export type SearchEntityCategoryQueryResult = Apollo.QueryResult<
  SearchEntityCategoryQuery,
  SearchEntityCategoryQueryVariables
>
 ...
 * });
 */
export function useListEntityCategoryQuery(
  baseOptions?: ApolloReactHooks.QueryHookOptions<
    ListEntityCategoryQuery,
    ListEntityCategoryQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions }
  return ApolloReactHooks.useQuery<ListEntityCategoryQuery, ListEntityCategoryQueryVariables>(
    ListEntityCategoryDocument,
    options
  )
}
export function useListEntityCategoryLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
    ListEntityCategoryQuery,
    ListEntityCategoryQueryVariables
  >
  ...
  const options = { ...defaultOptions, ...baseOptions }
  return ApolloReactHooks.useLazyQuery<ListEntityCategoryQuery, ListEntityCategoryQueryVariables>(
    ListEntityCategoryDocument,
    options
  )
}
export type ListEntityCategoryQueryHookResult = ReturnType<typeof useListEntityCategoryQuery>
export type ListEntityCategoryLazyQueryHookResult = ReturnType<
  typeof useListEntityCategoryLazyQuery
>
export type ListEntityCategoryQueryResult = Apollo.QueryResult<
  ListEntityCategoryQuery,
  ListEntityCategoryQueryVariables
>
 ...
 * });
 */
export function useEntityNodesQuery(
  baseOptions: ApolloReactHooks.QueryHookOptions<EntityNodesQuery, EntityNodesQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions }
  return ApolloReactHooks.useQuery<EntityNodesQuery, EntityNodesQueryVariables>(
    EntityNodesDocument,
    options
  )
}
export function useEntityNodesLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<EntityNodesQuery, EntityNodesQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions }
  return ApolloReactHooks.useLazyQuery<EntityNodesQuery, EntityNodesQueryVariables>(
    EntityNodesDocument,
    options
  )
}
 ...
 * });
 */
export function useEntityCategoryStatsQuery(
  baseOptions: ApolloReactHooks.QueryHookOptions<
    EntityCategoryStatsQuery,
    EntityCategoryStatsQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions }
  return ApolloReactHooks.useQuery<EntityCategoryStatsQuery, EntityCategoryStatsQueryVariables>(
    EntityCategoryStatsDocument,
    options
  )
}
export function useEntityCategoryStatsLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
    EntityCategoryStatsQuery,
    EntityCategoryStatsQueryVariables
  >
  ...
  const options = { ...defaultOptions, ...baseOptions }
  return ApolloReactHooks.useLazyQuery<EntityCategoryStatsQuery, EntityCategoryStatsQueryVariables>(
    EntityCategoryStatsDocument,
    options
  )
}
export type EntityCategoryStatsQueryHookResult = ReturnType<typeof useEntityCategoryStatsQuery>
export type EntityCategoryStatsLazyQueryHookResult = ReturnType<
  typeof useEntityCategoryStatsLazyQuery
>
export type EntityCategoryStatsQueryResult = Apollo.QueryResult<
  EntityCategoryStatsQuery,
  EntityCategoryStatsQueryVariables
>
 ...
 * });
 */
export function useHomePageStatsQuery(
  baseOptions?: ApolloReactHooks.QueryHookOptions<HomePageStatsQuery, HomePageStatsQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions }
  return ApolloReactHooks.useQuery<HomePageStatsQuery, HomePageStatsQueryVariables>(
    HomePageStatsDocument,
    options
  )
}
export function useHomePageStatsLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
    HomePageStatsQuery,
    HomePageStatsQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions }
  return ApolloReactHooks.useLazyQuery<HomePageStatsQuery, HomePageStatsQueryVariables>(
    HomePageStatsDocument,
    options
  )
}
...
export type HomePageStatsQueryResult = Apollo.QueryResult<
  HomePageStatsQuery,
  HomePageStatsQueryVariables
>
 ...
 * });
 */
export function useGetMeasurmentCategoryQuery(
  baseOptions: ApolloReactHooks.QueryHookOptions<
    GetMeasurmentCategoryQuery,
    GetMeasurmentCategoryQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions }
  return ApolloReactHooks.useQuery<GetMeasurmentCategoryQuery, GetMeasurmentCategoryQueryVariables>(
    GetMeasurmentCategoryDocument,
    options
  )
}
export function useGetMeasurmentCategoryLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
    GetMeasurmentCategoryQuery,
    GetMeasurmentCategoryQueryVariables
  >
  ...
  return ApolloReactHooks.useLazyQuery<
    GetMeasurmentCategoryQuery,
    GetMeasurmentCategoryQueryVariables
  >(GetMeasurmentCategoryDocument, options)
}
export type GetMeasurmentCategoryQueryHookResult = ReturnType<typeof useGetMeasurmentCategoryQuery>
export type GetMeasurmentCategoryLazyQueryHookResult = ReturnType<
  typeof useGetMeasurmentCategoryLazyQuery
>
export type GetMeasurmentCategoryQueryResult = Apollo.QueryResult<
  GetMeasurmentCategoryQuery,
  GetMeasurmentCategoryQueryVariables
>
 ...
 * });
 */
export function useSearchMeasurmentCategoryQuery(
  baseOptions?: ApolloReactHooks.QueryHookOptions<
    SearchMeasurmentCategoryQuery,
    SearchMeasurmentCategoryQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions }
  return ApolloReactHooks.useQuery<
    SearchMeasurmentCategoryQuery,
    SearchMeasurmentCategoryQueryVariables
  >(SearchMeasurmentCategoryDocument, options)
}
export function useSearchMeasurmentCategoryLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
    SearchMeasurmentCategoryQuery,
    SearchMeasurmentCategoryQueryVariables
  >
...
export type SearchMeasurmentCategoryQueryHookResult = ReturnType<
  typeof useSearchMeasurmentCategoryQuery
>
export type SearchMeasurmentCategoryLazyQueryHookResult = ReturnType<
  typeof useSearchMeasurmentCategoryLazyQuery
>
export type SearchMeasurmentCategoryQueryResult = Apollo.QueryResult<
  SearchMeasurmentCategoryQuery,
  SearchMeasurmentCategoryQueryVariables
>
 ...
 * });
 */
export function useListMeasurmentCategoryQuery(
  baseOptions?: ApolloReactHooks.QueryHookOptions<
    ListMeasurmentCategoryQuery,
    ListMeasurmentCategoryQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions }
  return ApolloReactHooks.useQuery<
    ListMeasurmentCategoryQuery,
    ListMeasurmentCategoryQueryVariables
  >(ListMeasurmentCategoryDocument, options)
}
export function useListMeasurmentCategoryLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
    ListMeasurmentCategoryQuery,
    ListMeasurmentCategoryQueryVariables
  >
...
export type ListMeasurmentCategoryQueryHookResult = ReturnType<
  typeof useListMeasurmentCategoryQuery
>
export type ListMeasurmentCategoryLazyQueryHookResult = ReturnType<
  typeof useListMeasurmentCategoryLazyQuery
>
export type ListMeasurmentCategoryQueryResult = Apollo.QueryResult<
  ListMeasurmentCategoryQuery,
  ListMeasurmentCategoryQueryVariables
>
 ...
 * });
 */
export function useGetMetricCategoryQuery(
  baseOptions: ApolloReactHooks.QueryHookOptions<
    GetMetricCategoryQuery,
    GetMetricCategoryQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions }
  return ApolloReactHooks.useQuery<GetMetricCategoryQuery, GetMetricCategoryQueryVariables>(
    GetMetricCategoryDocument,
    options
  )
}
export function useGetMetricCategoryLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
    GetMetricCategoryQuery,
    GetMetricCategoryQueryVariables
  >
  ...
  const options = { ...defaultOptions, ...baseOptions }
  return ApolloReactHooks.useLazyQuery<GetMetricCategoryQuery, GetMetricCategoryQueryVariables>(
    GetMetricCategoryDocument,
    options
  )
}
...
export type GetMetricCategoryQueryResult = Apollo.QueryResult<
  GetMetricCategoryQuery,
  GetMetricCategoryQueryVariables
>
 ...
 * });
 */
export function useListMetricCategoryQuery(
  baseOptions?: ApolloReactHooks.QueryHookOptions<
    ListMetricCategoryQuery,
    ListMetricCategoryQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions }
  return ApolloReactHooks.useQuery<ListMetricCategoryQuery, ListMetricCategoryQueryVariables>(
    ListMetricCategoryDocument,
    options
  )
}
export function useListMetricCategoryLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
    ListMetricCategoryQuery,
    ListMetricCategoryQueryVariables
  >
  ...
  const options = { ...defaultOptions, ...baseOptions }
  return ApolloReactHooks.useLazyQuery<ListMetricCategoryQuery, ListMetricCategoryQueryVariables>(
    ListMetricCategoryDocument,
    options
  )
}
export type ListMetricCategoryQueryHookResult = ReturnType<typeof useListMetricCategoryQuery>
export type ListMetricCategoryLazyQueryHookResult = ReturnType<
  typeof useListMetricCategoryLazyQuery
>
export type ListMetricCategoryQueryResult = Apollo.QueryResult<
  ListMetricCategoryQuery,
  ListMetricCategoryQueryVariables
>
 ...
 * });
 */
export function useSearchMetricCategoryQuery(
  baseOptions?: ApolloReactHooks.QueryHookOptions<
    SearchMetricCategoryQuery,
    SearchMetricCategoryQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions }
  return ApolloReactHooks.useQuery<SearchMetricCategoryQuery, SearchMetricCategoryQueryVariables>(
    SearchMetricCategoryDocument,
    options
  )
}
export function useSearchMetricCategoryLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
    SearchMetricCategoryQuery,
    SearchMetricCategoryQueryVariables
  >
  ...
  return ApolloReactHooks.useLazyQuery<
    SearchMetricCategoryQuery,
    SearchMetricCategoryQueryVariables
  >(SearchMetricCategoryDocument, options)
}
export type SearchMetricCategoryQueryHookResult = ReturnType<typeof useSearchMetricCategoryQuery>
export type SearchMetricCategoryLazyQueryHookResult = ReturnType<
  typeof useSearchMetricCategoryLazyQuery
>
export type SearchMetricCategoryQueryResult = Apollo.QueryResult<
  SearchMetricCategoryQuery,
  SearchMetricCategoryQueryVariables
>
 ...
 * });
 */
export function useGetNaturalEventCategoryQuery(
  baseOptions: ApolloReactHooks.QueryHookOptions<
    GetNaturalEventCategoryQuery,
    GetNaturalEventCategoryQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions }
  return ApolloReactHooks.useQuery<
    GetNaturalEventCategoryQuery,
    GetNaturalEventCategoryQueryVariables
  >(GetNaturalEventCategoryDocument, options)
}
export function useGetNaturalEventCategoryLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
    GetNaturalEventCategoryQuery,
    GetNaturalEventCategoryQueryVariables
  >
...
export type GetNaturalEventCategoryQueryHookResult = ReturnType<
  typeof useGetNaturalEventCategoryQuery
>
export type GetNaturalEventCategoryLazyQueryHookResult = ReturnType<
  typeof useGetNaturalEventCategoryLazyQuery
>
export type GetNaturalEventCategoryQueryResult = Apollo.QueryResult<
  GetNaturalEventCategoryQuery,
  GetNaturalEventCategoryQueryVariables
>
 ...
 * });
 */
export function useSearchNaturalEventCategoriesQuery(
  baseOptions?: ApolloReactHooks.QueryHookOptions<
    SearchNaturalEventCategoriesQuery,
    SearchNaturalEventCategoriesQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions }
  return ApolloReactHooks.useQuery<
    SearchNaturalEventCategoriesQuery,
    SearchNaturalEventCategoriesQueryVariables
  >(SearchNaturalEventCategoriesDocument, options)
}
export function useSearchNaturalEventCategoriesLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
    SearchNaturalEventCategoriesQuery,
    SearchNaturalEventCategoriesQueryVariables
  >
...
export type SearchNaturalEventCategoriesQueryHookResult = ReturnType<
  typeof useSearchNaturalEventCategoriesQuery
>
export type SearchNaturalEventCategoriesLazyQueryHookResult = ReturnType<
  typeof useSearchNaturalEventCategoriesLazyQuery
>
export type SearchNaturalEventCategoriesQueryResult = Apollo.QueryResult<
  SearchNaturalEventCategoriesQuery,
  SearchNaturalEventCategoriesQueryVariables
>
 ...
 * });
 */
export function useListNaturalEventCategoriesQuery(
  baseOptions?: ApolloReactHooks.QueryHookOptions<
    ListNaturalEventCategoriesQuery,
    ListNaturalEventCategoriesQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions }
  return ApolloReactHooks.useQuery<
    ListNaturalEventCategoriesQuery,
    ListNaturalEventCategoriesQueryVariables
  >(ListNaturalEventCategoriesDocument, options)
}
export function useListNaturalEventCategoriesLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
    ListNaturalEventCategoriesQuery,
    ListNaturalEventCategoriesQueryVariables
  >
...
export type ListNaturalEventCategoriesQueryHookResult = ReturnType<
  typeof useListNaturalEventCategoriesQuery
>
export type ListNaturalEventCategoriesLazyQueryHookResult = ReturnType<
  typeof useListNaturalEventCategoriesLazyQuery
>
export type ListNaturalEventCategoriesQueryResult = Apollo.QueryResult<
  ListNaturalEventCategoriesQuery,
  ListNaturalEventCategoriesQueryVariables
>
 ...
 * });
 */
export function useGetProtocolEventCategoryQuery(
  baseOptions: ApolloReactHooks.QueryHookOptions<
    GetProtocolEventCategoryQuery,
    GetProtocolEventCategoryQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions }
  return ApolloReactHooks.useQuery<
    GetProtocolEventCategoryQuery,
    GetProtocolEventCategoryQueryVariables
  >(GetProtocolEventCategoryDocument, options)
}
export function useGetProtocolEventCategoryLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
    GetProtocolEventCategoryQuery,
    GetProtocolEventCategoryQueryVariables
  >
...
export type GetProtocolEventCategoryQueryHookResult = ReturnType<
  typeof useGetProtocolEventCategoryQuery
>
export type GetProtocolEventCategoryLazyQueryHookResult = ReturnType<
  typeof useGetProtocolEventCategoryLazyQuery
>
export type GetProtocolEventCategoryQueryResult = Apollo.QueryResult<
  GetProtocolEventCategoryQuery,
  GetProtocolEventCategoryQueryVariables
>
 ...
 * });
 */
export function useSearchProtocolEventCategoriesQuery(
  baseOptions?: ApolloReactHooks.QueryHookOptions<
    SearchProtocolEventCategoriesQuery,
    SearchProtocolEventCategoriesQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions }
  return ApolloReactHooks.useQuery<
    SearchProtocolEventCategoriesQuery,
    SearchProtocolEventCategoriesQueryVariables
  >(SearchProtocolEventCategoriesDocument, options)
}
export function useSearchProtocolEventCategoriesLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
    SearchProtocolEventCategoriesQuery,
    SearchProtocolEventCategoriesQueryVariables
  >
...
export type SearchProtocolEventCategoriesQueryHookResult = ReturnType<
  typeof useSearchProtocolEventCategoriesQuery
>
export type SearchProtocolEventCategoriesLazyQueryHookResult = ReturnType<
  typeof useSearchProtocolEventCategoriesLazyQuery
>
export type SearchProtocolEventCategoriesQueryResult = Apollo.QueryResult<
  SearchProtocolEventCategoriesQuery,
  SearchProtocolEventCategoriesQueryVariables
>
 ...
 * });
 */
export function useListProtocolEventCategoriesQuery(
  baseOptions?: ApolloReactHooks.QueryHookOptions<
    ListProtocolEventCategoriesQuery,
    ListProtocolEventCategoriesQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions }
  return ApolloReactHooks.useQuery<
    ListProtocolEventCategoriesQuery,
    ListProtocolEventCategoriesQueryVariables
  >(ListProtocolEventCategoriesDocument, options)
}
export function useListProtocolEventCategoriesLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
    ListProtocolEventCategoriesQuery,
    ListProtocolEventCategoriesQueryVariables
  >
...
export type ListProtocolEventCategoriesQueryHookResult = ReturnType<
  typeof useListProtocolEventCategoriesQuery
>
export type ListProtocolEventCategoriesLazyQueryHookResult = ReturnType<
  typeof useListProtocolEventCategoriesLazyQuery
>
export type ListProtocolEventCategoriesQueryResult = Apollo.QueryResult<
  ListProtocolEventCategoriesQuery,
  ListProtocolEventCategoriesQueryVariables
>
 ...
 * });
 */
export function useGetRelationCategoryQuery(
  baseOptions: ApolloReactHooks.QueryHookOptions<
    GetRelationCategoryQuery,
    GetRelationCategoryQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions }
  return ApolloReactHooks.useQuery<GetRelationCategoryQuery, GetRelationCategoryQueryVariables>(
    GetRelationCategoryDocument,
    options
  )
}
export function useGetRelationCategoryLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
    GetRelationCategoryQuery,
    GetRelationCategoryQueryVariables
  >
  ...
  const options = { ...defaultOptions, ...baseOptions }
  return ApolloReactHooks.useLazyQuery<GetRelationCategoryQuery, GetRelationCategoryQueryVariables>(
    GetRelationCategoryDocument,
    options
  )
}
export type GetRelationCategoryQueryHookResult = ReturnType<typeof useGetRelationCategoryQuery>
export type GetRelationCategoryLazyQueryHookResult = ReturnType<
  typeof useGetRelationCategoryLazyQuery
>
export type GetRelationCategoryQueryResult = Apollo.QueryResult<
  GetRelationCategoryQuery,
  GetRelationCategoryQueryVariables
>
 ...
 * });
 */
export function useSearchRelationCategoryQuery(
  baseOptions?: ApolloReactHooks.QueryHookOptions<
    SearchRelationCategoryQuery,
    SearchRelationCategoryQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions }
  return ApolloReactHooks.useQuery<
    SearchRelationCategoryQuery,
    SearchRelationCategoryQueryVariables
  >(SearchRelationCategoryDocument, options)
}
export function useSearchRelationCategoryLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
    SearchRelationCategoryQuery,
    SearchRelationCategoryQueryVariables
  >
...
export type SearchRelationCategoryQueryHookResult = ReturnType<
  typeof useSearchRelationCategoryQuery
>
export type SearchRelationCategoryLazyQueryHookResult = ReturnType<
  typeof useSearchRelationCategoryLazyQuery
>
export type SearchRelationCategoryQueryResult = Apollo.QueryResult<
  SearchRelationCategoryQuery,
  SearchRelationCategoryQueryVariables
>
 ...
 * });
 */
export function useListRelationCategoryQuery(
  baseOptions?: ApolloReactHooks.QueryHookOptions<
    ListRelationCategoryQuery,
    ListRelationCategoryQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions }
  return ApolloReactHooks.useQuery<ListRelationCategoryQuery, ListRelationCategoryQueryVariables>(
    ListRelationCategoryDocument,
    options
  )
}
export function useListRelationCategoryLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
    ListRelationCategoryQuery,
    ListRelationCategoryQueryVariables
  >
  ...
  return ApolloReactHooks.useLazyQuery<
    ListRelationCategoryQuery,
    ListRelationCategoryQueryVariables
  >(ListRelationCategoryDocument, options)
}
export type ListRelationCategoryQueryHookResult = ReturnType<typeof useListRelationCategoryQuery>
export type ListRelationCategoryLazyQueryHookResult = ReturnType<
  typeof useListRelationCategoryLazyQuery
>
export type ListRelationCategoryQueryResult = Apollo.QueryResult<
  ListRelationCategoryQuery,
  ListRelationCategoryQueryVariables
>
 ...
 * });
 */
export function useGetStructureRelationCategoryQuery(
  baseOptions: ApolloReactHooks.QueryHookOptions<
    GetStructureRelationCategoryQuery,
    GetStructureRelationCategoryQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions }
  return ApolloReactHooks.useQuery<
    GetStructureRelationCategoryQuery,
    GetStructureRelationCategoryQueryVariables
  >(GetStructureRelationCategoryDocument, options)
}
export function useGetStructureRelationCategoryLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
    GetStructureRelationCategoryQuery,
    GetStructureRelationCategoryQueryVariables
  >
...
export type GetStructureRelationCategoryQueryHookResult = ReturnType<
  typeof useGetStructureRelationCategoryQuery
>
export type GetStructureRelationCategoryLazyQueryHookResult = ReturnType<
  typeof useGetStructureRelationCategoryLazyQuery
>
export type GetStructureRelationCategoryQueryResult = Apollo.QueryResult<
  GetStructureRelationCategoryQuery,
  GetStructureRelationCategoryQueryVariables
>
 ...
 * });
 */
export function useSearchStructureRelationCategoryQuery(
  baseOptions?: ApolloReactHooks.QueryHookOptions<
    SearchStructureRelationCategoryQuery,
    SearchStructureRelationCategoryQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions }
  return ApolloReactHooks.useQuery<
    SearchStructureRelationCategoryQuery,
    SearchStructureRelationCategoryQueryVariables
  >(SearchStructureRelationCategoryDocument, options)
}
export function useSearchStructureRelationCategoryLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
    SearchStructureRelationCategoryQuery,
    SearchStructureRelationCategoryQueryVariables
  >
...
export type SearchStructureRelationCategoryQueryHookResult = ReturnType<
  typeof useSearchStructureRelationCategoryQuery
>
export type SearchStructureRelationCategoryLazyQueryHookResult = ReturnType<
  typeof useSearchStructureRelationCategoryLazyQuery
>
export type SearchStructureRelationCategoryQueryResult = Apollo.QueryResult<
  SearchStructureRelationCategoryQuery,
  SearchStructureRelationCategoryQueryVariables
>
 ...
 * });
 */
export function useListStructureRelationCategoryQuery(
  baseOptions?: ApolloReactHooks.QueryHookOptions<
    ListStructureRelationCategoryQuery,
    ListStructureRelationCategoryQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions }
  return ApolloReactHooks.useQuery<
    ListStructureRelationCategoryQuery,
    ListStructureRelationCategoryQueryVariables
  >(ListStructureRelationCategoryDocument, options)
}
export function useListStructureRelationCategoryLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
    ListStructureRelationCategoryQuery,
    ListStructureRelationCategoryQueryVariables
  >
...
export type ListStructureRelationCategoryQueryHookResult = ReturnType<
  typeof useListStructureRelationCategoryQuery
>
export type ListStructureRelationCategoryLazyQueryHookResult = ReturnType<
  typeof useListStructureRelationCategoryLazyQuery
>
export type ListStructureRelationCategoryQueryResult = Apollo.QueryResult<
  ListStructureRelationCategoryQuery,
  ListStructureRelationCategoryQueryVariables
>
 ...
 * });
 */
export function useStartPaneQuery(
  baseOptions?: ApolloReactHooks.QueryHookOptions<StartPaneQuery, StartPaneQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions }
  return ApolloReactHooks.useQuery<StartPaneQuery, StartPaneQueryVariables>(
    StartPaneDocument,
    options
  )
}
export function useStartPaneLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<StartPaneQuery, StartPaneQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions }
  return ApolloReactHooks.useLazyQuery<StartPaneQuery, StartPaneQueryVariables>(
    StartPaneDocument,
    options
  )
}
 ...
 * });
 */
export function useGetStructureQuery(
  baseOptions: ApolloReactHooks.QueryHookOptions<GetStructureQuery, GetStructureQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions }
  return ApolloReactHooks.useQuery<GetStructureQuery, GetStructureQueryVariables>(
    GetStructureDocument,
    options
  )
}
export function useGetStructureLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<GetStructureQuery, GetStructureQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions }
  return ApolloReactHooks.useLazyQuery<GetStructureQuery, GetStructureQueryVariables>(
    GetStructureDocument,
    options
  )
}
...
export type GetStructureQueryResult = Apollo.QueryResult<
  GetStructureQuery,
  GetStructureQueryVariables
>
 ...
 * });
 */
export function useSearchStructuresQuery(
  baseOptions: ApolloReactHooks.QueryHookOptions<
  ...
  const options = { ...defaultOptions, ...baseOptions }
  return ApolloReactHooks.useQuery<SearchStructuresQuery, SearchStructuresQueryVariables>(
    SearchStructuresDocument,
    options
  )
}
export function useSearchStructuresLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
    SearchStructuresQuery,
    SearchStructuresQueryVariables
  >
  ...
  const options = { ...defaultOptions, ...baseOptions }
  return ApolloReactHooks.useLazyQuery<SearchStructuresQuery, SearchStructuresQueryVariables>(
    SearchStructuresDocument,
    options
  )
}
...
export type SearchStructuresQueryResult = Apollo.QueryResult<
  SearchStructuresQuery,
  SearchStructuresQueryVariables
>
 ...
 * });
 */
export function useGetInformedStructureQuery(
  baseOptions: ApolloReactHooks.QueryHookOptions<
    GetInformedStructureQuery,
    GetInformedStructureQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions }
  return ApolloReactHooks.useQuery<GetInformedStructureQuery, GetInformedStructureQueryVariables>(
    GetInformedStructureDocument,
    options
  )
}
export function useGetInformedStructureLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
    GetInformedStructureQuery,
    GetInformedStructureQueryVariables
  >
  ...
  return ApolloReactHooks.useLazyQuery<
    GetInformedStructureQuery,
    GetInformedStructureQueryVariables
  >(GetInformedStructureDocument, options)
}
export type GetInformedStructureQueryHookResult = ReturnType<typeof useGetInformedStructureQuery>
export type GetInformedStructureLazyQueryHookResult = ReturnType<
  typeof useGetInformedStructureLazyQuery
>
export type GetInformedStructureQueryResult = Apollo.QueryResult<
  GetInformedStructureQuery,
  GetInformedStructureQueryVariables
>
 ...
 * });
 */
export function useListStructuresQuery(
  baseOptions: ApolloReactHooks.QueryHookOptions<ListStructuresQuery, ListStructuresQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions }
  return ApolloReactHooks.useQuery<ListStructuresQuery, ListStructuresQueryVariables>(
    ListStructuresDocument,
    options
  )
}
export function useListStructuresLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
    ListStructuresQuery,
  ...
  const options = { ...defaultOptions, ...baseOptions }
  return ApolloReactHooks.useLazyQuery<ListStructuresQuery, ListStructuresQueryVariables>(
    ListStructuresDocument,
    options
  )
}
...
export type ListStructuresQueryResult = Apollo.QueryResult<
  ListStructuresQuery,
  ListStructuresQueryVariables
>
 ...
 * });
 */
export function useGetStructureCategoryQuery(
  baseOptions: ApolloReactHooks.QueryHookOptions<
    GetStructureCategoryQuery,
    GetStructureCategoryQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions }
  return ApolloReactHooks.useQuery<GetStructureCategoryQuery, GetStructureCategoryQueryVariables>(
    GetStructureCategoryDocument,
    options
  )
}
export function useGetStructureCategoryLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
    GetStructureCategoryQuery,
    GetStructureCategoryQueryVariables
  >
  ...
  return ApolloReactHooks.useLazyQuery<
    GetStructureCategoryQuery,
    GetStructureCategoryQueryVariables
  >(GetStructureCategoryDocument, options)
}
export type GetStructureCategoryQueryHookResult = ReturnType<typeof useGetStructureCategoryQuery>
export type GetStructureCategoryLazyQueryHookResult = ReturnType<
  typeof useGetStructureCategoryLazyQuery
>
export type GetStructureCategoryQueryResult = Apollo.QueryResult<
  GetStructureCategoryQuery,
  GetStructureCategoryQueryVariables
>
 ...
 * });
 */
export function useSearchStructureCategoryQuery(
  baseOptions?: ApolloReactHooks.QueryHookOptions<
    SearchStructureCategoryQuery,
    SearchStructureCategoryQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions }
  return ApolloReactHooks.useQuery<
    SearchStructureCategoryQuery,
    SearchStructureCategoryQueryVariables
  >(SearchStructureCategoryDocument, options)
}
export function useSearchStructureCategoryLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
    SearchStructureCategoryQuery,
    SearchStructureCategoryQueryVariables
  >
...
export type SearchStructureCategoryQueryHookResult = ReturnType<
  typeof useSearchStructureCategoryQuery
>
export type SearchStructureCategoryLazyQueryHookResult = ReturnType<
  typeof useSearchStructureCategoryLazyQuery
>
export type SearchStructureCategoryQueryResult = Apollo.QueryResult<
  SearchStructureCategoryQuery,
  SearchStructureCategoryQueryVariables
>
 ...
 * });
 */
export function useListStructureCategoryQuery(
  baseOptions?: ApolloReactHooks.QueryHookOptions<
    ListStructureCategoryQuery,
    ListStructureCategoryQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions }
  return ApolloReactHooks.useQuery<ListStructureCategoryQuery, ListStructureCategoryQueryVariables>(
    ListStructureCategoryDocument,
    options
  )
}
export function useListStructureCategoryLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
    ListStructureCategoryQuery,
    ListStructureCategoryQueryVariables
  >
  ...
  return ApolloReactHooks.useLazyQuery<
    ListStructureCategoryQuery,
    ListStructureCategoryQueryVariables
  >(ListStructureCategoryDocument, options)
}
export type ListStructureCategoryQueryHookResult = ReturnType<typeof useListStructureCategoryQuery>
export type ListStructureCategoryLazyQueryHookResult = ReturnType<
  typeof useListStructureCategoryLazyQuery
>
export type ListStructureCategoryQueryResult = Apollo.QueryResult<
  ListStructureCategoryQuery,
  ListStructureCategoryQueryVariables
>
 ...
 * });
 */
export function useGetStructureRelationQuery(
  baseOptions: ApolloReactHooks.QueryHookOptions<
    GetStructureRelationQuery,
    GetStructureRelationQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions }
  return ApolloReactHooks.useQuery<GetStructureRelationQuery, GetStructureRelationQueryVariables>(
    GetStructureRelationDocument,
    options
  )
}
export function useGetStructureRelationLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
    GetStructureRelationQuery,
    GetStructureRelationQueryVariables
  >
  ...
  return ApolloReactHooks.useLazyQuery<
    GetStructureRelationQuery,
    GetStructureRelationQueryVariables
  >(GetStructureRelationDocument, options)
}
export type GetStructureRelationQueryHookResult = ReturnType<typeof useGetStructureRelationQuery>
export type GetStructureRelationLazyQueryHookResult = ReturnType<
  typeof useGetStructureRelationLazyQuery
>
export type GetStructureRelationQueryResult = Apollo.QueryResult<
  GetStructureRelationQuery,
  GetStructureRelationQueryVariables
>
 ...
 * });
 */
export function useSearchStructureRelationsQuery(
  baseOptions: ApolloReactHooks.QueryHookOptions<
    SearchStructureRelationsQuery,
    SearchStructureRelationsQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions }
  return ApolloReactHooks.useQuery<
    SearchStructureRelationsQuery,
    SearchStructureRelationsQueryVariables
  >(SearchStructureRelationsDocument, options)
}
export function useSearchStructureRelationsLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
    SearchStructureRelationsQuery,
    SearchStructureRelationsQueryVariables
  >
...
export type SearchStructureRelationsQueryHookResult = ReturnType<
  typeof useSearchStructureRelationsQuery
>
export type SearchStructureRelationsLazyQueryHookResult = ReturnType<
  typeof useSearchStructureRelationsLazyQuery
>
export type SearchStructureRelationsQueryResult = Apollo.QueryResult<
  SearchStructureRelationsQuery,
  SearchStructureRelationsQueryVariables
>
export const SearchTagsDocument = gql`
  query SearchTags($search: String, $values: [ID!]) {
    options: categoryTags(filters: { search: $search, ids: $values }, pagination: { limit: 10 }) {
      value: id
      label: name
    }
  }
...
export function useSearchTagsQuery(
  baseOptions?: ApolloReactHooks.QueryHookOptions<SearchTagsQuery, SearchTagsQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions }
  return ApolloReactHooks.useQuery<SearchTagsQuery, SearchTagsQueryVariables>(
    SearchTagsDocument,
    options
  )
}
export function useSearchTagsLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<SearchTagsQuery, SearchTagsQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions }
  return ApolloReactHooks.useLazyQuery<SearchTagsQuery, SearchTagsQueryVariables>(
    SearchTagsDocument,
    options
  )
}

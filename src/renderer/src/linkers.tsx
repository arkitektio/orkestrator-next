...
import { ListFileFragment, ListImageFragment } from "./mikro-next/api/graphql";
...
export const MikroImage = buildSmart<ListImageFragment>(
  "@mikro/image",
  "mikro/images",
  { name: "Image (Mikro)" },
);
...
export const MikroFileView = buildSmart<ListFileFragment>(
  "@mikro/fileview",
  "mikro/fileviews",
  { name: "File View" },
);

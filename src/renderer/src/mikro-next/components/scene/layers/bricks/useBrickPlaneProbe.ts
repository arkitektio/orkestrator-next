...
import { effectiveProbeLayerId, layerAnswersProbe } from "../../core/probe/probeTargeting";
...
import { useSceneStore, useSceneStoreApi, type LayerState } from "../../store/sceneStore";

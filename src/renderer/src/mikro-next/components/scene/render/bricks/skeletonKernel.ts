...
import { tetTableWGSL } from "../../core/skeleton/tetTable";
import type { Vec3 } from "../../core/skeleton/strokeModel";

/**
 * The GPU skeleton kernels (compute-shader port of `core/skeleton/`): the
 ...
 * unit-testable against the `core/skeleton` reference without a GPU;
 ...
 * (`core/skeleton/tubeMarch.ts` is the CPU twin; the case table is
